...
// 20.09.2026, лента .wAuthorRibbon (index.html) — три захода в разговоре: (1) текст «Звезда
// автора» → «Космо-звезда» (отклонено ещё на макете), (2) 5 звёзд-рейтинга (владелец сперва
// одобрил живьём, потом сам поймал проблему — «5 звёзд это как бы об оценке»), (3) финал —
// созвездие: 5 точек, соединённых тонкими линиями (макет masterskaya-lenta-interesnye-idei-
// 20-09-2026.html, вариант «А», владелец: «ни о чём не говорит как оценка, однако выделяет
// как символ»). ОДИН svg с реальными координатами из макета, не 5 повторов — линии рисуют
// связь между точками, отдельные одинаковые иконки такого эффекта дать не могут.
const WORKSHOP_RIBBON_CONSTELLATION='<svg viewBox="0 0 60 26">'+
  '<g stroke="#6b4d10" stroke-width="1" opacity=".8">'+
  '<line x1="6" y1="18" x2="18" y2="8"/><line x1="18" y1="8" x2="32" y2="14"/>'+
  '<line x1="32" y1="14" x2="46" y2="6"/><line x1="32" y1="14" x2="40" y2="20"/>'+
  '</g><g fill="#2c1f08">'+
  '<circle cx="6" cy="18" r="2.6"/><circle cx="18" cy="8" r="2.2"/>'+
  '<circle cx="32" cy="14" r="2.8"/><circle cx="46" cy="6" r="2.2"/><circle cx="40" cy="20" r="2"/>'+
  '</g></svg>';
