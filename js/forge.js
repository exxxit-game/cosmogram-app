...
const FORGE_PRESETS=[ // точки входа: тапнул — и сразу летишь; докрутить можно под себя
  ...
  {k:'fpMines', c:{n:'',d:55,s:45,e:136,l:3500,lv:3,w:3,fl:0,b:2,sky:300,h1:78,h2:118,fog:0,sc:[ // 08.09.2026, замена «Ад на одну жизнь» (дублировал Створ): мины+ворота, скорость нарочно ниже средней — ставка на выбор пути, не на реакцию, щедрые паузы, чтобы успеть посмотреть и решить
