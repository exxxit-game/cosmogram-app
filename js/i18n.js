...
const I18N = {
  ...
  es:{
    ...
    setVibro:'Vibración', setContrast:'Alto contraste', setColorblind:'Asistencia daltonismo', setReduceShake:'Suavizar sacudidas y destellos', setTextScale:'Tamaño del texto', setGfx:'Gráficos', gfxAuto:'Auto', gfxLow:'Baja', gfxMed:'Media', gfxHigh:'Alta', gfxUltra:'Ultra',
  ...
  pt:{
    ...
    setVibro:'Vibração', setContrast:'Alto contraste', setColorblind:'Assistência daltonismo', setReduceShake:'Suavizar tremor e flashes', setTextScale:'Tamanho do texto', setGfx:'Gráficos', gfxAuto:'Automático', gfxLow:'Baixa', gfxMed:'Média', gfxHigh:'Alta', gfxUltra:'Ultra',
