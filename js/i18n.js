...
const I18N = {
  ru: {
   ...
   workshopAuthor:(n)=>'Автор: '+n, // 08.09.2026: имя автора теперь показано на самой карточке (владелец, живой макет), не только внутри «Мои»; 09.09.2026, владелец: «не создал, а автор» — точнее слово
    ...
    grLead:'Каждое спасибо в Stars зажигает звезду в одном небе для всех.',
    grCardT:'Ваша звезда', grCommentLbl:'Комментарий', grCommentPh:'Космическое спасибо', grAmountLbl:'Сколько Stars — решаете сами',
