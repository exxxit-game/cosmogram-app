...
const I18N = {
  ru: {
    ...
    // себя, #workshopSub скрыт классом .hidden в index.html). Только RU — EN/ES/PT/FR ещё не
    // сделаны, отмечено явно, не молчаливый пробел.
    ...
    workshopVoteOwnTrack:'Нельзя лайкать свою же трассу', // 14.09.2026 (аудит «борьба с читерами»): сервер тихо не засчитывает лайк автору собственного кода — этот тост объясняет честно, не как «нет соединения»
    ...
    workshopReport:'Пожаловаться', workshopReported:'Мы проверим название этого неба.', // 05.09.2026: EN/ES/PT/FR ниже ещё без этих ключей; 08.09.2026 (владелец, живой макет): было «Спасибо, посмотрим» — не говорило, кому жалуешься и на что; текст теперь называет ровно что проверяется
  ...
  fr:{
    ...
    angarTabDecal:'Emoji', decalCatNames:{none:'Sans décoration',space:'Espace',zodiac:'Zodiaque',weather:'Météo',faces:'Visages',nature:'Nature',games:'Jeux',crafts:'Loisirs créatifs',animals:'Animaux',moon:'Lune',music:'Musique',myth:'Mythe',status:'Statut',vehicles:'Véhicules',food:'Nourriture',sport:'Sport',tech:'Technologie',fashion:'Mode',symbols:'Symboles',landscape:'Paysage',holidays:'Fêtes',landmarks:'Monuments',science:'Science',flags:'Drapeaux',hearts:'Cœurs',fx:'Effets',sealife:'Vie marine',bugs:'Insectes',awards:'Récompenses',body:'Corps',family:'Famille',hands:'Mains',household:'Maison',medical:'Médical',money:'Argent',office:'Bureau',person:'Personnes',time:'Temps',tools:'Outils',iBasic:'Basique',iSpace:'Espace',iStatus:'Statut',iElem:'Éléments',iTech:'Technologie',iSpecial:'Spécial',iSecrets:'Sécurité et secrets',iParty:'Fête et cadeaux',iSea:'Mer et rivage',iNature:'Nature',iFlight:'Vol',iSky:'Ciel',iExplore:'Exploration',iMagic:'Magie et couleur',iNight:'Nuit et mystère',iTime:'Temps',iSignals:'Signaux',iTools:'Outils',iAbstract:'Abstrait',iHomes:'Maisons',iMind:'Esprit et savoir',iSound:'Son',iVehicles:'Véhicules',iGames:'Jeux',iAdventure:'Hiver et aventure',iTravel:'Voyages'}, angarTabFlash:'Éclat', angarTabTrail:'Traînée',
