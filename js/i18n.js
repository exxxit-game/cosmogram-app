...
const I18N = {
  ru: {
    ...
    workshopSort_new:'Новые', workshopSort_top:'Топ', workshopSort_fav:'Избранное', workshopSort_mine:'Мои', workshopSort_random:'Сюрприз',
    ...
    // «Растёт» (набирает популярность) — НЕ добавлено: нужен новый sort на живом Edge Function
    // cosmogram-workshop, которого нет в локальном репозитории и который я не могу задеплоить
    // без авторизованного Supabase MCP — отдельная задача, не в этом заходе.
