...
const I18N = {
  ru: {
    ...
    diagBtn:'Отладка', diagSensorOk:'Датчик жив · ', diagChanTg:'канал Telegram', diagChanWeb:'веб-канал', // 15.09.2026: было «Сервисный центр» → «Диагностика» (тоже не влезала одной строкой, 179px против запаса 158px, слово без пробелов не переносится) → «Отладка» (владелец, из 3 вариантов)
  ...
  en: {
    ...
    diagBtn:'Debug', diagSensorOk:'Sensor alive · ', diagChanTg:'Telegram channel', diagChanWeb:'web channel',
  ...
  fr:{
    ...
    diagBtn:'Débogage', diagSensorOk:'Capteur actif · ', diagChanTg:'Canal Telegram', diagChanWeb:'canal web',
