...
const I18N = {
  ru: {
    ...
    angarTabDecal:'Декаль', decalCatNames:{space:'Космос',zodiac:'Зодиак',weather:'Погода',faces:'Смайлы',nature:'Природа',games:'Игры',animals:'Животные',moon:'Луна',music:'Музыка',myth:'Мифы',status:'Статус'},
  ...
  en: {
    ...
    angarTabDecal:'Decal', decalCatNames:{space:'Space',zodiac:'Zodiac',weather:'Weather',faces:'Faces',nature:'Nature',games:'Games',animals:'Animals',moon:'Moon',music:'Music',myth:'Myth',status:'Status'},
  ...
  es:{
    ...
    angarTabDecal:'Calcomanía', decalCatNames:{space:'Espacio',zodiac:'Zodíaco',weather:'Clima',faces:'Caras',nature:'Naturaleza',games:'Juegos',animals:'Animales',moon:'Luna',music:'Música',myth:'Mito',status:'Estatus'},
  ...
  pt:{
    ...
    angarTabDecal:'Decalque', decalCatNames:{space:'Espaço',zodiac:'Zodíaco',weather:'Clima',faces:'Rostos',nature:'Natureza',games:'Jogos',animals:'Animais',moon:'Lua',music:'Música',myth:'Mito',status:'Status'},
  ...
  fr:{
    ...
    angarTabDecal:'Décalque', decalCatNames:{space:'Espace',zodiac:'Zodiaque',weather:'Météo',faces:'Visages',nature:'Nature',games:'Jeux',animals:'Animaux',moon:'Lune',music:'Musique',myth:'Mythe',status:'Statut'},
