...
const I18N = {
  ru: {
    ...
    workshopSort_new:'Новые', workshopSort_top:'Лайки', workshopSort_plays:'Игры', workshopSort_mine:'Мои', workshopSort_pinned:'Закреплённые',
    // 07.09.2026, владелец: «Лучшие» не объясняло критерий, «Играли больше всех» громоздко — обе вкладки на короткую параллельную пару
    // 08.09.2026, владелец, живой скрин: «приставку "по" убрать» — «По лайкам»/«По играм»→«Лайки»/«Игры», короче и в один ряд с «Новые»/«Мои».
    ...
    // «Закреплённые»: то, что владелец явно отметил как рекомендуемое, показывает ТОЛЬКО
    // закреплённое (не «пришпиленные сверху», это и так уже есть у Новые/Лайки/Игры — отдельная
    // вкладка с тем же эффектом была бы бессмысленным дублем), полезно всем, не только авторам.
