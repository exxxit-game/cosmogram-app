...
const I18N = {
  ru: {
    ...
    forgeHarmonyBtnLbl:'Подобрать гармонию', forgeHarmonyTitle:'Гармония цвета',
    ...
    grPrivacyNote:'Сумму твоей благодарности видит только владелец игры. Имя и комментарий увидят все, если не включишь «анонимно».',
    grCardT:'Твоя звезда', grCommentLbl:'Комментарий (необязательно)', grAmountLbl:'Сколько Stars — сам решаешь',
  ...
  en: {
    ...
    forgeHarmonyBtnLbl:'Find harmony', forgeHarmonyTitle:'Color harmony',
    ...
    grCardT:'Your star', grCommentLbl:'Comment (optional)', grAmountLbl:'How many Stars — you decide',
  ...
  es:{
    ...
    forgeHarmonyBtnLbl:'Buscar armonía', forgeHarmonyTitle:'Armonía de color',
    ...
    grCardT:'Tu estrella', grCommentLbl:'Comentario (opcional)', grAmountLbl:'Cuántos Stars — tú decides',
  ...
  pt:{
    ...
    forgeHarmonyBtnLbl:'Encontrar harmonia', forgeHarmonyTitle:'Harmonia de cor',
    ...
    grCardT:'A tua estrela', grCommentLbl:'Comentário (opcional)', grAmountLbl:'Quantos Stars — tu decides',
  ...
  fr:{
    ...
    forgeHarmonyBtnLbl:'Trouver une harmonie', forgeHarmonyTitle:'Harmonie des couleurs',
    ...
    grCardT:'Ton étoile', grCommentLbl:'Commentaire (facultatif)', grAmountLbl:'Combien de Stars — c’est toi qui décides',
