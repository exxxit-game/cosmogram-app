...
const I18N = {
  ru: {
   ...
   workshopAuthor:(n)=>'Автор: '+n, // 08.09.2026: имя автора теперь показано на самой карточке (владелец, живой макет), не только внутри «Мои»; 09.09.2026, владелец: «не создал, а автор» — точнее слово
    ...
    forgeRecapLen:'Длина', forgeRecapPts:'Точек',
  ...
  en: {
    ...
    forgeRecapLen:'Length', forgeRecapPts:'Points',
  ...
  es:{
    ...
    forgeRecapLen:'Longitud', forgeRecapPts:'Puntos',
  ...
  pt:{
    ...
    forgeRecapLen:'Comprimento', forgeRecapPts:'Pontos',
  ...
  fr:{
    ...
    forgeRecapLen:'Longueur', forgeRecapPts:'Points',
