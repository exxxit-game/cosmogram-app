...
const I18N = {
  ru: {
    ...
    feedbackHint:'Идея, вопрос или ошибка — сообщение уходит прямо владельцу игры.',
  ...
  en: {
    ...
    feedbackHint:'An idea, a question, or a bug — your message goes straight to the game’s owner.',
  ...
  es:{
    ...
    feedbackHint:'Una idea, una pregunta o un error — tu mensaje llega directo al dueño del juego.',
  ...
  pt:{
    ...
    feedbackHint:'Uma ideia, uma pergunta ou um erro — sua mensagem vai direto para o dono do jogo.',
  ...
  fr:{
    ...
    feedbackHint:'Une idée, une question ou un bug — ton message part directement au propriétaire du jeu.',
