...
const I18N = {
  ru: {
   ...
   workshopAuthor:(n)=>'Автор: '+n, // 08.09.2026: имя автора теперь показано на самой карточке (владелец, живой макет), не только внутри «Мои»; 09.09.2026, владелец: «не создал, а автор» — точнее слово
    ...
    grCardT:'Ваша звезда', grCommentPh:'Место для комментария, если вам захочется добавить — например, «космическое спасибо»',
  ...
  en: {
    ...
    grCardT:'Your star', grCommentPh:'A place for a comment, if you’d like to add one — for example, “cosmic thanks”',
  ...
  es:{
    ...
    grCardT:'Tu estrella', grCommentPh:'Un espacio para un comentario, si quieres añadir uno — por ejemplo, «gracias cósmicas»',
  ...
  pt:{
    ...
    grCardT:'A tua estrela', grCommentPh:'Um espaço para um comentário, se quiseres acrescentar um — por exemplo, «obrigado cósmico»',
  ...
  fr:{
    ...
    grCardT:'Ton étoile', grCommentPh:'Un espace pour un commentaire, si tu veux en ajouter un — par exemple, « merci cosmique »',
