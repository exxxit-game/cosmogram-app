...
const I18N = {
  ru: {
   ...
   workshopAuthor:(n)=>'Автор: '+n, // 08.09.2026: имя автора теперь показано на самой карточке (владелец, живой макет), не только внутри «Мои»; 09.09.2026, владелец: «не создал, а автор» — точнее слово
    ...
    galTitle:'Видео полётов', galDoorLbl:'Видео полётов', galPinFirst:'Первый', galEmptySlot:'пока нет рекорда', galEmptyFirst:'пока нет видео', galRelayNote:'нет рекорда для Эстафеты', // 16.09.2026 «Галерея видео-рекордов»: ffcSub убран — старый подзаголовок «Сохранено навсегда» показывался только на удалённой широкой карточке, теперь нигде не используется
    ...
    grAnonLbl:'Анонимно — имя не покажется другим', grSendLbl:'Отправить через Stars',
    gratitudeSignInFirst:'войди через Telegram, чтобы отправить звезду',
    gratitudeEmptySky:'пока небо пустое — стань первой звездой',
    grAnonLabel:'Аноним', grReported:'Спасибо, мы посмотрим', grSendFail:'Не получилось — попробуй ещё раз',
    grSent:'Звезда зажглась. Спасибо!', grNameHidden:'Имя скрыто — отправишь анонимно',
  ...
  en: {
    ...
    workshopSort_new:'New', workshopSort_top:'Top', workshopSort_fav:'Favorites', workshopSort_mine:'Mine', workshopSort_random:'Surprise', workshopSort_trending:'Trending',
    workshopFeatured:'Marked with a gold star', workshopUnfeatured:'Mark removed',
    workshopVoteLocked:'Finish the flight to rate it',
    workshopPlay:'Fly', workshopEdit:'Edit', workshopPlays:(n)=>'Runs: '+n, workshopHearts:(n)=>'Likes: '+n,
    ...
    galTitle:'Flight videos', galDoorLbl:'Flight videos', galPinFirst:'First', galEmptySlot:'no record yet', galEmptyFirst:'no video yet', galRelayNote:'no record for Relay',
  ...
  es:{
    ...
    workshopSort_new:'Nuevos', workshopSort_top:'Top', workshopSort_fav:'Favoritos', workshopSort_mine:'Míos', workshopSort_random:'Sorpresa', workshopSort_trending:'Tendencia',
    ...
    workshopPlay:'Volar', workshopEdit:'Editar', workshopPlays:(n)=>'Vuelos: '+n, workshopHearts:(n)=>'Me gusta: '+n,
    ...
    galTitle:'Vídeos de vuelos', galDoorLbl:'Vídeos de vuelos', galPinFirst:'Primero', galEmptySlot:'aún sin récord', galEmptyFirst:'aún sin vídeo', galRelayNote:'sin récord para Relevos',
  ...
  pt:{
    ...
    workshopSort_new:'Novos', workshopSort_top:'Top', workshopSort_fav:'Favoritos', workshopSort_mine:'Meus', workshopSort_random:'Surpresa', workshopSort_trending:'Em alta',
    ...
    workshopPlay:'Voar', workshopEdit:'Editar', workshopPlays:(n)=>'Voos: '+n, workshopHearts:(n)=>'Gostos: '+n,
    workshopAuthor:(n)=>'Autor: '+n,
    ...
    galTitle:'Vídeos de voos', galDoorLbl:'Vídeos de voos', galPinFirst:'Primeiro', galEmptySlot:'ainda sem recorde', galEmptyFirst:'ainda sem vídeo', galRelayNote:'sem recorde para Revezamento',
  ...
  fr:{
    ...
    workshopSort_new:'Nouveaux', workshopSort_top:'Top', workshopSort_fav:'Favoris', workshopSort_mine:'Les miens', workshopSort_random:'Surprise', workshopSort_trending:'Tendance',
    ...
    workshopPlay:'Voler', workshopEdit:'Modifier', workshopPlays:(n)=>'Vols : '+n, workshopHearts:(n)=>"J'aime : "+n,
    ...
    galTitle:'Vidéos de vols', galDoorLbl:'Vidéos de vols', galPinFirst:'Premier', galEmptySlot:'pas encore de record', galEmptyFirst:'pas encore de vidéo', galRelayNote:'pas de record pour Relais',
