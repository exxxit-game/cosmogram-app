...
const I18N = {
  ru: {
    ...
    setVibro:'Виброотклик', setContrast:'Высокий контраст', setColorblind:'Для дальтоников', setReduceShake:'Смягчить тряску и вспышки',
  ...
  en: {
    ...
    setVibro:'Haptics', setContrast:'High contrast', setColorblind:'Colorblind assist', setReduceShake:'Soften shake & flashes',
  ...
  es:{
    ...
    setVibro:'Vibración', setContrast:'Alto contraste', setColorblind:'Asistencia daltonismo', setReduceShake:'Suavizar sacudidas y destellos', setGfx:'Gráficos', gfxAuto:'Auto', gfxLow:'Baja', gfxMed:'Media', gfxHigh:'Alta', gfxUltra:'Ultra',
  ...
  pt:{
    ...
    setVibro:'Vibração', setContrast:'Alto contraste', setColorblind:'Assistência daltonismo', setReduceShake:'Suavizar tremor e flashes', setGfx:'Gráficos', gfxAuto:'Automático', gfxLow:'Baixa', gfxMed:'Média', gfxHigh:'Alta', gfxUltra:'Ultra',
  ...
  fr:{
    ...
    setVibro:'Vibrations', setContrast:'Contraste élevé', setColorblind:'Assistance daltonisme', setReduceShake:'Adoucir secousses et flashs',
