...
const I18N = {
  ru: {
    ...
    feedbackHint:'Идея, вопрос или ошибка — сообщение уходит прямо создателю игры. Читаем каждое сообщение — нам важно мнение и мысли игроков.',
  ...
  en: {
    ...
    feedbackHint:'An idea, a question, or a bug — your message goes straight to the game’s creator. We read every message — your thoughts matter to us.',
  ...
  es:{
    ...
    feedbackHint:'Una idea, una pregunta o un error — tu mensaje llega directo al creador del juego. Leemos cada mensaje — tu opinión nos importa.',
  ...
  pt:{
    ...
    feedbackHint:'Uma ideia, uma pergunta ou um erro — sua mensagem vai direto para o criador do jogo. Lemos cada mensagem — sua opinião é importante para nós.',
  ...
  fr:{
    ...
    feedbackHint:'Une idée, une question ou un bug — ton message part directement au créateur du jeu. On lit chaque message — ton avis compte pour nous.',
