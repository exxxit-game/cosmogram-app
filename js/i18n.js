...
const I18N = {
  ru: {
    ...
    cosmos:'Космос', culture:'Культура'}, // 05.09.2026: разделы Вспышки/Следа/Скина — EN/ES/PT/FR ниже ещё без этих ключей; 06.09.2026: lsystem отсутствовал даже здесь — категория показывалась сырым «LSYSTEM» на любом языке;
