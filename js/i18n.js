...
const I18N = {
  ru: {
    ...
    workshopPlay:'В полёт', workshopEdit:'Изменить', // 06.09.2026: «В Кузницу» — Кузница как отдельное место больше не существует; 07.09.2026: было короткое «Открыть» рядом с «Играть» одинаковым весом — путало (два похожих варианта); теперь словом-ссылкой второго яруса, полная фраза не нуждается в соседстве с «Играть», чтобы быть понятной; 08.09.2026: «Открыть в Конструкторе» — само название экрана в названии кнопки, хотя мы уже внутри Конструктора; «Изменить» короче и не повторяется; «Играть»→«В полёт» (владелец, живой макет) — стоит парой с «Изменить», без иконки
