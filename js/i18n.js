...
const I18N = {
  ru: {
    ...
    workshopSort_new:'Новые', workshopSort_top:'Лайки', workshopSort_topLiked:'Твои', workshopSort_plays:'Полёты', workshopSort_mine:'Мои', workshopSort_random:'Случайные',
    ...
    workshopAuthor:(n)=>'Создал: '+n, // 08.09.2026: имя автора теперь показано на самой карточке (владелец, живой макет), не только внутри «Мои»
