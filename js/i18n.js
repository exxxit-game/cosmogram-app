...
const I18N = {
  ru: {
    ...
    channel:'Наш канал', toRecord:'До рекорда: ', welcomeMsg:'Привет',
    ...
    angarTabDecal:'Декаль', decalCatNames:{space:'Космос',zodiac:'Зодиак',weather:'Погода',faces:'Смайлы',nature:'Природа',games:'Игры',animals:'Животные',moon:'Луна',music:'Музыка',myth:'Мифы',status:'Статус',vehicles:'Транспорт',food:'Еда',sport:'Спорт',tech:'Техника',fashion:'Мода',symbols:'Символы',landscape:'Ландшафт',holidays:'Праздники',landmarks:'Ориентиры',science:'Наука',flags:'Флаги',icons:'Иконки'},
  ...
  en: {
    ...
    channel:'Our channel', toRecord:'To beat: ', welcomeMsg:'Hi',
    ...
    angarTabDecal:'Decal', decalCatNames:{space:'Space',zodiac:'Zodiac',weather:'Weather',faces:'Faces',nature:'Nature',games:'Games',animals:'Animals',moon:'Moon',music:'Music',myth:'Myth',status:'Status',vehicles:'Vehicles',food:'Food',sport:'Sport',tech:'Tech',fashion:'Fashion',symbols:'Symbols',landscape:'Landscape',holidays:'Holidays',landmarks:'Landmarks',science:'Science',flags:'Flags',icons:'Icons'},
  ...
  es:{
    ...
    setSound:'Sonido', setMusic:'Música', setLang:'Idioma', langAuto:'Auto', channel:'Nuestro canal', welcomeMsg:'Hola',
    ...
    angarTabDecal:'Calcomanía', decalCatNames:{space:'Espacio',zodiac:'Zodíaco',weather:'Clima',faces:'Caras',nature:'Naturaleza',games:'Juegos',animals:'Animales',moon:'Luna',music:'Música',myth:'Mito',status:'Estatus',vehicles:'Vehículos',food:'Comida',sport:'Deporte',tech:'Tecnología',fashion:'Moda',symbols:'Símbolos',landscape:'Paisaje',holidays:'Fiestas',landmarks:'Monumentos',science:'Ciencia',flags:'Banderas',icons:'Íconos'},
  ...
  pt:{
    ...
    setSound:'Som', setMusic:'Música', setLang:'Idioma', langAuto:'Automático', channel:'Nosso canal', welcomeMsg:'Olá',
    ...
    angarTabDecal:'Decalque', decalCatNames:{space:'Espaço',zodiac:'Zodíaco',weather:'Clima',faces:'Rostos',nature:'Natureza',games:'Jogos',animals:'Animais',moon:'Lua',music:'Música',myth:'Mito',status:'Status',vehicles:'Veículos',food:'Comida',sport:'Esporte',tech:'Tecnologia',fashion:'Moda',symbols:'Símbolos',landscape:'Paisagem',holidays:'Festas',landmarks:'Marcos',science:'Ciência',flags:'Bandeiras',icons:'Ícones'},
  ...
  fr:{
    ...
    channel:'Notre chaîne', toRecord:'À battre : ', welcomeMsg:'Salut',
    ...
    angarTabDecal:'Décalque', decalCatNames:{space:'Espace',zodiac:'Zodiaque',weather:'Météo',faces:'Visages',nature:'Nature',games:'Jeux',animals:'Animaux',moon:'Lune',music:'Musique',myth:'Mythe',status:'Statut',vehicles:'Véhicules',food:'Nourriture',sport:'Sport',tech:'Technologie',fashion:'Mode',symbols:'Symboles',landscape:'Paysage',holidays:'Fêtes',landmarks:'Monuments',science:'Science',flags:'Drapeaux',icons:'Icônes'},
