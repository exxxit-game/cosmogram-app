...
const I18N = {
  ru: {
    ...
    classic:'Классика', live:'Живые', sacred:'Сакральная геометрия', superformula:'Суперформула Гилиса', roses:'Розы Родонеи', premium:'Премиум', celtic:'Кельтское плетение'}, // 05.09.2026: разделы Вспышки/Следа — EN/ES/PT/FR ниже ещё без этих ключей
