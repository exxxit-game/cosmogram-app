...
const DECALS=[
  ...
  {id:218, name:'Любовное письмо', price:80, ch:'💌', cat:'hearts'},
  {id:219, name:'Сердце-стрела', price:80, ch:'💘', cat:'hearts'},
  {id:220, name:'Сердце с лентой', price:80, ch:'💝', cat:'hearts'},
  {id:221, name:'Искрящееся сердце', price:80, ch:'💖', cat:'hearts'},
  {id:222, name:'Растущее сердце', price:80, ch:'💗', cat:'hearts'},
  {id:223, name:'Бьющееся сердце', price:80, ch:'💓', cat:'hearts'},
  {id:224, name:'Кружащиеся сердца', price:80, ch:'💞', cat:'hearts'},
  {id:225, name:'Два сердца', price:80, ch:'💕', cat:'hearts'},
  {id:226, name:'Сердце-украшение', price:80, ch:'💟', cat:'hearts'},
  {id:227, name:'Сердце-восклицание', price:80, ch:'❣️', cat:'hearts'},
  {id:228, name:'Разбитое сердце', price:80, ch:'💔', cat:'hearts'},
  {id:229, name:'Красное сердце', price:80, ch:'❤️', cat:'hearts'},
  {id:230, name:'Розовое сердце', price:80, ch:'🩷', cat:'hearts'},
  {id:231, name:'Оранжевое сердце', price:80, ch:'🧡', cat:'hearts'},
  {id:232, name:'Жёлтое сердце', price:80, ch:'💛', cat:'hearts'},
  {id:233, name:'Зелёное сердце', price:80, ch:'💚', cat:'hearts'},
  {id:234, name:'Синее сердце', price:80, ch:'💙', cat:'hearts'},
  {id:235, name:'Голубое сердце', price:80, ch:'🩵', cat:'hearts'},
  {id:236, name:'Фиолетовое сердце', price:80, ch:'💜', cat:'hearts'},
  {id:237, name:'Коричневое сердце', price:80, ch:'🤎', cat:'hearts'},
  {id:238, name:'Чёрное сердце', price:80, ch:'🖤', cat:'hearts'},
  {id:239, name:'Серое сердце', price:80, ch:'🩶', cat:'hearts'},
  {id:240, name:'Белое сердце', price:80, ch:'🤍', cat:'hearts'},
  {id:241, name:'След поцелуя', price:80, ch:'💋', cat:'fx'},
  {id:242, name:'Символ гнева', price:80, ch:'💢', cat:'fx'},
  {id:243, name:'Облако драки', price:80, ch:'🫯', cat:'fx'},
  {id:244, name:'Столкновение', price:80, ch:'💥', cat:'fx'},
  {id:245, name:'Головокружение', price:80, ch:'💫', cat:'fx'},
  {id:246, name:'Капли пота', price:80, ch:'💦', cat:'fx'},
  {id:247, name:'Стремительный уход', price:80, ch:'💨', cat:'fx'},
  {id:248, name:'Дыра', price:80, ch:'🕳️', cat:'fx'},
  {id:249, name:'Речевой пузырь', price:80, ch:'💬', cat:'fx'},
  {id:250, name:'Пузырь слева', price:80, ch:'🗨️', cat:'fx'},
  {id:251, name:'Пузырь гнева', price:80, ch:'🗯️', cat:'fx'},
  {id:252, name:'Пузырь мысли', price:80, ch:'💭', cat:'fx'},
  {id:253, name:'Храп ZZZ', price:80, ch:'💤', cat:'fx'},
  {id:254, name:'Морда обезьяны', price:120, ch:'🐵', cat:'animals'},
  {id:255, name:'Обезьяна', price:120, ch:'🐒', cat:'animals'},
  {id:256, name:'Горилла', price:120, ch:'🦍', cat:'animals'},
  {id:257, name:'Орангутан', price:120, ch:'🦧', cat:'animals'},
  {id:258, name:'Морда собаки', price:120, ch:'🐶', cat:'animals'},
  {id:259, name:'Собака', price:120, ch:'🐕', cat:'animals'},
  {id:260, name:'Собака-поводырь', price:120, ch:'🦮', cat:'animals'},
  {id:261, name:'Пудель', price:120, ch:'🐩', cat:'animals'},
  {id:262, name:'Енот', price:120, ch:'🦝', cat:'animals'},
  {id:263, name:'Морда кота', price:120, ch:'🐱', cat:'animals'},
  {id:264, name:'Кот', price:120, ch:'🐈', cat:'animals'},
  {id:265, name:'Тигр (мордочка)', price:120, ch:'🐅', cat:'animals'},
  {id:266, name:'Морда лошади', price:120, ch:'🐴', cat:'animals'},
  {id:267, name:'Лось', price:120, ch:'🫎', cat:'animals'},
  {id:268, name:'Осёл', price:120, ch:'🫏', cat:'animals'},
  {id:269, name:'Лошадь', price:120, ch:'🐎', cat:'animals'},
  {id:270, name:'Бизон', price:120, ch:'🦬', cat:'animals'},
  {id:271, name:'Морда коровы', price:120, ch:'🐮', cat:'animals'},
  {id:272, name:'Вол', price:120, ch:'🐂', cat:'animals'},
  {id:273, name:'Буйвол', price:120, ch:'🐃', cat:'animals'},
  {id:274, name:'Корова', price:120, ch:'🐄', cat:'animals'},
  {id:275, name:'Морда свиньи', price:120, ch:'🐷', cat:'animals'},
  {id:276, name:'Свинья', price:120, ch:'🐖', cat:'animals'},
  {id:277, name:'Кабан', price:120, ch:'🐗', cat:'animals'},
  {id:278, name:'Пятачок', price:120, ch:'🐽', cat:'animals'},
  {id:279, name:'Баран', price:120, ch:'🐏', cat:'animals'},
  {id:280, name:'Овца', price:120, ch:'🐑', cat:'animals'},
  {id:281, name:'Коза', price:120, ch:'🐐', cat:'animals'},
  {id:282, name:'Верблюд', price:120, ch:'🐪', cat:'animals'},
  {id:283, name:'Двугорбый верблюд', price:120, ch:'🐫', cat:'animals'},
  {id:284, name:'Лама', price:120, ch:'🦙', cat:'animals'},
  {id:285, name:'Мамонт', price:120, ch:'🦣', cat:'animals'},
  {id:286, name:'Бегемот', price:120, ch:'🦛', cat:'animals'},
  {id:287, name:'Морда мыши', price:120, ch:'🐭', cat:'animals'},
  {id:288, name:'Мышь', price:120, ch:'🐁', cat:'animals'},
  {id:289, name:'Крыса', price:120, ch:'🐀', cat:'animals'},
  {id:290, name:'Хомяк', price:120, ch:'🐹', cat:'animals'},
  {id:291, name:'Морда кролика', price:120, ch:'🐰', cat:'animals'},
  {id:292, name:'Кролик', price:120, ch:'🐇', cat:'animals'},
  {id:293, name:'Бурундук', price:120, ch:'🐿️', cat:'animals'},
  {id:294, name:'Бобр', price:120, ch:'🦫', cat:'animals'},
  {id:295, name:'Коала', price:120, ch:'🐨', cat:'animals'},
  {id:296, name:'Выдра', price:120, ch:'🦦', cat:'animals'},
  {id:297, name:'Скунс', price:120, ch:'🦨', cat:'animals'},
  {id:298, name:'Кенгуру', price:120, ch:'🦘', cat:'animals'},
  {id:299, name:'Барсук', price:120, ch:'🦡', cat:'animals'},
  {id:300, name:'Следы лап', price:120, ch:'🐾', cat:'animals'},
  {id:301, name:'Индюк', price:120, ch:'🦃', cat:'animals'},
  {id:302, name:'Курица', price:120, ch:'🐔', cat:'animals'},
  {id:303, name:'Петух', price:120, ch:'🐓', cat:'animals'},
  {id:304, name:'Вылупляющийся цыплёнок', price:120, ch:'🐣', cat:'animals'},
  {id:305, name:'Цыплёнок', price:120, ch:'🐤', cat:'animals'},
  {id:306, name:'Цыплёнок анфас', price:120, ch:'🐥', cat:'animals'},
  {id:307, name:'Птица', price:120, ch:'🐦', cat:'animals'},
  {id:308, name:'Пингвин', price:120, ch:'🐧', cat:'animals'},
  {id:309, name:'Голубь', price:120, ch:'🕊️', cat:'animals'},
  {id:310, name:'Утка', price:120, ch:'🦆', cat:'animals'},
  {id:311, name:'Лебедь', price:120, ch:'🦢', cat:'animals'},
  {id:312, name:'Додо', price:120, ch:'🦤', cat:'animals'},
  {id:313, name:'Перо', price:120, ch:'🪶', cat:'animals'},
  {id:314, name:'Крыло', price:120, ch:'🪽', cat:'animals'},
  {id:315, name:'Гусь', price:120, ch:'🪿', cat:'animals'},
  {id:316, name:'Лягушка', price:120, ch:'🐸', cat:'animals'},
  {id:317, name:'Змея', price:120, ch:'🐍', cat:'animals'},
  {id:318, name:'Фонтанирующий кит', price:120, ch:'🐳', cat:'sealife'},
  {id:319, name:'Косатка', price:120, ch:'🫍', cat:'sealife'},
  {id:320, name:'Тюлень', price:120, ch:'🦭', cat:'sealife'},
  {id:321, name:'Рыба', price:120, ch:'🐟', cat:'sealife'},
  {id:322, name:'Тропическая рыба', price:120, ch:'🐠', cat:'sealife'},
  {id:323, name:'Рыба-шар', price:120, ch:'🐡', cat:'sealife'},
  {id:324, name:'Ракушка', price:120, ch:'🐚', cat:'sealife'},
  {id:325, name:'Коралл', price:120, ch:'🪸', cat:'sealife'},
  {id:326, name:'Медуза', price:120, ch:'🪼', cat:'sealife'},
  {id:327, name:'Краб', price:120, ch:'🦀', cat:'sealife'},
  {id:328, name:'Омар', price:120, ch:'🦞', cat:'sealife'},
  {id:329, name:'Креветка', price:120, ch:'🦐', cat:'sealife'},
  {id:330, name:'Устрица', price:120, ch:'🦪', cat:'sealife'},
  {id:331, name:'Букашка', price:100, ch:'🐛', cat:'bugs'},
  {id:332, name:'Муравей', price:100, ch:'🐜', cat:'bugs'},
  {id:333, name:'Жук', price:100, ch:'🪲', cat:'bugs'},
  {id:334, name:'Божья коровка', price:100, ch:'🐞', cat:'bugs'},
  {id:335, name:'Сверчок', price:100, ch:'🦗', cat:'bugs'},
  {id:336, name:'Таракан', price:100, ch:'🪳', cat:'bugs'},
  {id:337, name:'Паутина', price:100, ch:'🕸️', cat:'bugs'},
  {id:338, name:'Комар', price:100, ch:'🦟', cat:'bugs'},
  {id:339, name:'Муха', price:100, ch:'🪰', cat:'bugs'},
  {id:340, name:'Червяк', price:100, ch:'🪱', cat:'bugs'},
  {id:341, name:'Микроб', price:100, ch:'🦠', cat:'bugs'},
  {id:342, name:'Букет', price:80, ch:'💐', cat:'nature'},
  {id:343, name:'Белый цветок', price:80, ch:'💮', cat:'nature'},
  {id:344, name:'Розетка-цветок', price:80, ch:'🏵️', cat:'nature'},
  {id:345, name:'Увядший цветок', price:80, ch:'🥀', cat:'nature'},
  {id:346, name:'Цветение', price:80, ch:'🌼', cat:'nature'},
  {id:347, name:'Тюльпан', price:80, ch:'🌷', cat:'nature'},
  {id:348, name:'Гиацинт', price:80, ch:'🪻', cat:'nature'},
  {id:349, name:'Росток', price:80, ch:'🌱', cat:'nature'},
  {id:350, name:'Цветок в горшке', price:80, ch:'🪴', cat:'nature'},
  {id:351, name:'Вечнозелёное дерево', price:80, ch:'🌲', cat:'nature'},
  {id:352, name:'Лиственное дерево', price:80, ch:'🌳', cat:'nature'},
  {id:353, name:'Трава-приправа', price:80, ch:'🌿', cat:'nature'},
  {id:354, name:'Трилистник', price:80, ch:'☘️', cat:'nature'},
  {id:355, name:'Опавший лист', price:80, ch:'🍂', cat:'nature'},
  {id:356, name:'Лист на ветру', price:80, ch:'🍃', cat:'nature'},
  {id:357, name:'Пустое гнездо', price:80, ch:'🪹', cat:'nature'},
  {id:358, name:'Гнездо с яйцами', price:80, ch:'🪺', cat:'nature'},
  {id:359, name:'Голое дерево', price:80, ch:'🪾', cat:'nature'},
  {id:360, name:'Глобус: Европа-Африка', price:80, ch:'🌍', cat:'landscape'},
  {id:361, name:'Глобус: Америка', price:80, ch:'🌎', cat:'landscape'},
  {id:362, name:'Глобус: Азия-Австралия', price:80, ch:'🌏', cat:'landscape'},
  {id:363, name:'Глобус с меридианами', price:80, ch:'🌐', cat:'landscape'},
  {id:364, name:'Карта мира', price:80, ch:'🗺️', cat:'landscape'},
  {id:365, name:'Карта Японии', price:80, ch:'🗾', cat:'landscape'},
  {id:366, name:'Гора (вектор эмодзи)', price:80, ch:'⛰️', cat:'landscape'},
  {id:367, name:'Оползень (эмодзи)', price:80, ch:'🛘', cat:'landscape'},
  {id:368, name:'Фудзияма', price:80, ch:'🗻', cat:'landscape'},
  {id:369, name:'Кемпинг', price:80, ch:'🏕️', cat:'landscape'},
  {id:370, name:'Пляж с зонтом', price:80, ch:'🏖️', cat:'landscape'},
  {id:371, name:'Нацпарк', price:80, ch:'🏞️', cat:'landscape'},
  {id:372, name:'Стадион', price:80, ch:'🏟️', cat:'landmarks'},
  {id:373, name:'Классическое здание', price:80, ch:'🏛️', cat:'landmarks'},
  {id:374, name:'Стройка (эмодзи)', price:80, ch:'🏗️', cat:'landmarks'},
  {id:375, name:'Кирпич', price:80, ch:'🧱', cat:'landmarks'},
  {id:376, name:'Камень', price:80, ch:'🪨', cat:'landmarks'},
  {id:377, name:'Дерево-брус', price:80, ch:'🪵', cat:'landmarks'},
  {id:378, name:'Хижина (эмодзи)', price:80, ch:'🛖', cat:'landmarks'},
  {id:379, name:'Дома', price:80, ch:'🏘️', cat:'landmarks'},
  {id:380, name:'Заброшенный дом', price:80, ch:'🏚️', cat:'landmarks'},
  {id:381, name:'Дом', price:80, ch:'🏠', cat:'landmarks'},
  {id:382, name:'Дом с садом', price:80, ch:'🏡', cat:'landmarks'},
  {id:383, name:'Офисное здание', price:80, ch:'🏢', cat:'landmarks'},
  {id:384, name:'Японская почта', price:80, ch:'🏣', cat:'landmarks'},
  {id:385, name:'Почта', price:80, ch:'🏤', cat:'landmarks'},
  {id:386, name:'Больница', price:80, ch:'🏥', cat:'landmarks'},
  {id:387, name:'Банк', price:80, ch:'🏦', cat:'landmarks'},
  {id:388, name:'Отель', price:80, ch:'🏨', cat:'landmarks'},
  {id:389, name:'Отель на час', price:80, ch:'🏩', cat:'landmarks'},
  {id:390, name:'Магазин у дома', price:80, ch:'🏪', cat:'landmarks'},
  {id:391, name:'Школа', price:80, ch:'🏫', cat:'landmarks'},
  {id:392, name:'Универмаг', price:80, ch:'🏬', cat:'landmarks'},
  {id:393, name:'Завод (эмодзи)', price:80, ch:'🏭', cat:'landmarks'},
  {id:394, name:'Японский замок', price:80, ch:'🏯', cat:'landmarks'},
  {id:395, name:'Свадьба', price:80, ch:'💒', cat:'landmarks'},
  {id:396, name:'Фонтан', price:80, ch:'⛲', cat:'landmarks'},
  {id:397, name:'Палатка', price:80, ch:'⛺', cat:'landmarks'},
  {id:398, name:'Туманно (эмодзи)', price:80, ch:'🌁', cat:'weather'},
  {id:399, name:'Ночь со звёздами', price:80, ch:'🌃', cat:'weather'},
  {id:400, name:'Городской пейзаж', price:80, ch:'🏙️', cat:'landmarks'},
  {id:401, name:'Рассвет над горами', price:80, ch:'🌄', cat:'landmarks'},
  {id:402, name:'Город в сумерках', price:80, ch:'🌆', cat:'weather'},
  {id:403, name:'Горячие источники', price:80, ch:'♨️', cat:'landmarks'},
  {id:404, name:'Карусель', price:80, ch:'🎠', cat:'landmarks'},
  {id:405, name:'Горка на площадке', price:80, ch:'🛝', cat:'landmarks'},
  {id:406, name:'Вывеска парикмахерской', price:80, ch:'💈', cat:'landmarks'},
  {id:407, name:'Цирковой шатёр', price:80, ch:'🎪', cat:'landmarks'},
  {id:408, name:'Вагон', price:80, ch:'🚃', cat:'vehicles'},
  {id:409, name:'Скоростной поезд', price:80, ch:'🚄', cat:'vehicles'},
  {id:410, name:'Поезд-пуля', price:80, ch:'🚅', cat:'vehicles'},
  {id:411, name:'Поезд', price:80, ch:'🚆', cat:'vehicles'},
  {id:412, name:'Метро', price:80, ch:'🚇', cat:'vehicles'},
  {id:413, name:'Лёгкое метро', price:80, ch:'🚈', cat:'vehicles'},
  {id:414, name:'Станция', price:80, ch:'🚉', cat:'vehicles'},
  {id:415, name:'Трамвай (эмодзи)', price:80, ch:'🚊', cat:'vehicles'},
  {id:416, name:'Монорельс', price:80, ch:'🚝', cat:'vehicles'},
  {id:417, name:'Горная железная дорога', price:80, ch:'🚞', cat:'vehicles'},
  {id:418, name:'Трамвайный вагон', price:80, ch:'🚋', cat:'vehicles'},
  {id:419, name:'Автобус', price:80, ch:'🚌', cat:'vehicles'},
  {id:420, name:'Автобус навстречу', price:80, ch:'🚍', cat:'vehicles'},
  {id:421, name:'Троллейбус', price:80, ch:'🚎', cat:'vehicles'},
  {id:422, name:'Маршрутка', price:80, ch:'🚐', cat:'vehicles'},
  {id:423, name:'Скорая помощь', price:80, ch:'🚑', cat:'vehicles'},
  {id:424, name:'Пожарная машина', price:80, ch:'🚒', cat:'vehicles'},
  {id:425, name:'Полицейская машина', price:80, ch:'🚓', cat:'vehicles'},
  {id:426, name:'Полиция навстречу', price:80, ch:'🚔', cat:'vehicles'},
  {id:427, name:'Такси', price:80, ch:'🚕', cat:'vehicles'},
  {id:428, name:'Такси навстречу', price:80, ch:'🚖', cat:'vehicles'},
  {id:429, name:'Машина навстречу', price:80, ch:'🚘', cat:'vehicles'},
  {id:430, name:'Внедорожник', price:80, ch:'🚙', cat:'vehicles'},
  {id:431, name:'Пикап', price:80, ch:'🛻', cat:'vehicles'},
  {id:432, name:'Фургон доставки', price:80, ch:'🚚', cat:'vehicles'},
  {id:433, name:'Фура', price:80, ch:'🚛', cat:'vehicles'},
  {id:434, name:'Трактор (эмодзи)', price:80, ch:'🚜', cat:'vehicles'},
  {id:435, name:'Мотоцикл (эмодзи)', price:80, ch:'🏍️', cat:'vehicles'},
  {id:436, name:'Мотороллер', price:80, ch:'🛵', cat:'vehicles'},
  {id:437, name:'Инвалидная коляска', price:80, ch:'🦽', cat:'vehicles'},
  {id:438, name:'Электроколяска', price:80, ch:'🦼', cat:'vehicles'},
  {id:439, name:'Тук-тук', price:80, ch:'🛺', cat:'vehicles'},
  {id:440, name:'Велосипед (эмодзи)', price:80, ch:'🚲', cat:'vehicles'},
  {id:441, name:'Самокат', price:80, ch:'🛴', cat:'vehicles'},
  {id:442, name:'Ролик', price:80, ch:'🛼', cat:'vehicles'},
  {id:443, name:'Автобусная остановка', price:80, ch:'🚏', cat:'vehicles'},
  {id:444, name:'Автомагистраль', price:80, ch:'🛣️', cat:'vehicles'},
  {id:445, name:'Рельсы', price:80, ch:'🛤️', cat:'vehicles'},
  {id:446, name:'Бочка нефти', price:80, ch:'🛢️', cat:'vehicles'},
  {id:447, name:'Бензоколонка', price:80, ch:'⛽', cat:'vehicles'},
  {id:448, name:'Колесо', price:80, ch:'🛞', cat:'vehicles'},
  {id:449, name:'Мигалка', price:80, ch:'🚨', cat:'vehicles'},
  {id:450, name:'Светофор (гориз.)', price:80, ch:'🚥', cat:'vehicles'},
  {id:451, name:'Светофор', price:80, ch:'🚦', cat:'vehicles'},
  {id:452, name:'Знак стоп', price:80, ch:'🛑', cat:'vehicles'},
  {id:453, name:'Дорожные работы', price:80, ch:'🚧', cat:'vehicles'},
  {id:454, name:'Спасательный круг', price:80, ch:'🛟', cat:'vehicles'},
  {id:455, name:'Каноэ', price:80, ch:'🛶', cat:'vehicles'},
  {id:456, name:'Катер', price:80, ch:'🚤', cat:'vehicles'},
  {id:457, name:'Пассажирский лайнер', price:80, ch:'🛳️', cat:'vehicles'},
  {id:458, name:'Паром', price:80, ch:'⛴️', cat:'vehicles'},
  {id:459, name:'Моторная лодка', price:80, ch:'🛥️', cat:'vehicles'},
  {id:460, name:'Вылет самолёта', price:80, ch:'🛫', cat:'vehicles'},
  {id:461, name:'Прилёт самолёта', price:80, ch:'🛬', cat:'vehicles'},
  {id:462, name:'Парашют', price:80, ch:'🪂', cat:'vehicles'},
  {id:463, name:'Кресло салона', price:80, ch:'💺', cat:'vehicles'},
  {id:464, name:'Подвесная дорога', price:80, ch:'🚟', cat:'vehicles'},
  {id:465, name:'Горная канатка', price:80, ch:'🚠', cat:'vehicles'},
  {id:466, name:'Канатный трамвай', price:80, ch:'🚡', cat:'vehicles'},
  {id:467, name:'Колокольчик портье', price:80, ch:'🛎️', cat:'landmarks'},
  {id:468, name:'Чемодан', price:80, ch:'🧳', cat:'landmarks'},
  {id:469, name:'Новолуние с лицом', price:80, ch:'🌚', cat:'weather'},
  {id:470, name:'Первая четверть с лицом', price:80, ch:'🌛', cat:'weather'},
  {id:471, name:'Последняя четверть с лицом', price:80, ch:'🌜', cat:'weather'},
  {id:472, name:'Полнолуние с лицом', price:80, ch:'🌝', cat:'weather'},
  {id:473, name:'Солнце с лицом', price:80, ch:'🌞', cat:'weather'},
  {id:474, name:'Звезда (эмодзи)', price:80, ch:'⭐', cat:'weather'},
  {id:475, name:'Облако (эмодзи)', price:80, ch:'☁️', cat:'weather'},
  {id:476, name:'Солнце за облаком', price:80, ch:'⛅', cat:'weather'},
  {id:477, name:'Солнце за облачком', price:80, ch:'🌤️', cat:'weather'},
  {id:478, name:'Солнце за тучей', price:80, ch:'🌥️', cat:'weather'},
  {id:479, name:'Солнце за дождевой тучей', price:80, ch:'🌦️', cat:'weather'},
  {id:480, name:'Туча со снегом', price:80, ch:'🌨️', cat:'weather'},
  {id:481, name:'Ветер с лицом', price:80, ch:'🌬️', cat:'weather'},
  {id:482, name:'Закрытый зонт', price:80, ch:'🌂', cat:'weather'},
  {id:483, name:'Зонт (эмодзи)', price:80, ch:'☂️', cat:'weather'},
  {id:484, name:'Зонт под дождём', price:80, ch:'☔', cat:'weather'},
  {id:485, name:'Пляжный зонт', price:80, ch:'⛱️', cat:'weather'},
  {id:486, name:'Снеговик', price:80, ch:'☃️', cat:'weather'},
  {id:487, name:'Снеговик без снега', price:80, ch:'⛄', cat:'weather'},
  {id:488, name:'Капля (эмодзи)', price:80, ch:'💧', cat:'weather'},
  {id:489, name:'Спортивная медаль', price:350, ch:'🏅', cat:'status'},
  {id:490, name:'Змееносец', price:80, ch:'⛎', cat:'zodiac'},
];
...
const ICONS=[
  ...
  {id:1, name:'Ракета (вектор)', price:150, vb:[0,-960,960,960], cat:'iBasic',
  ...
  {id:2, name:'Медаль (вектор)', price:150, vb:[0,-960,960,960], cat:'iBasic',
  ...
  {id:3, name:'Молния (вектор)', price:150, vb:[0,-960,960,960], cat:'iBasic',
    svg:'m320-80 40-280H160l360-520h80l-40 320h240L400-80h-80Z'},
  {id:4, name:'Бриллиант (вектор)', price:150, vb:[0,-960,960,960], cat:'iBasic',
  ...
  {id:5, name:'Щит (вектор)', price:150, vb:[0,-960,960,960], cat:'iBasic',
    svg:'M480-80q-139-35-229.5-159.5T160-516v-244l320-120 320 120v244q0 152-90.5 276.5T480-80Z'},
  {id:6, name:'Спутник (Iconки)', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:7, name:'Планета', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:8, name:'Ночное небо', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:9, name:'Звёзды', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:10, name:'Вспышка', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:11, name:'Сияние', price:150, vb:[0,0,24,24], cat:'iSpace',
  ...
  {id:12, name:'Сумерки', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:13, name:'Циклон (вектор)', price:150, vb:[0,-960,960,960], cat:'iSpace',
  ...
  {id:14, name:'Премиум-медаль', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:15, name:'Проверено', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:16, name:'Оценка-звезда', price:250, vb:[0,-960,960,960], cat:'iStatus',
    svg:'m233-120 65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Z'},
  {id:17, name:'Кубок-событие', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:18, name:'Гроза (вектор)', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:19, name:'Торнадо', price:150, vb:[0,-960,960,960], cat:'iElem',
    svg:'M40-840h880L804-640H156L40-840Zm162 280h556l-70 120H272l-70-120Zm116 200h324L480-80 318-360Z'},
  {id:20, name:'Капля', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:21, name:'Снежинка (вектор)', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:22, name:'Огонь (вектор)', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:23, name:'Вулкан (вектор)', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:24, name:'Волны (вектор)', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:25, name:'Безопасность', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:26, name:'Проверенный', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:27, name:'Забота о здоровье', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:28, name:'Сетевой узел', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:29, name:'Память/чип', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:30, name:'Волшебная коррекция', price:200, vb:[0,0,24,24], cat:'iSpecial',
  ...
  {id:31, name:'Идея', price:200, vb:[0,0,24,24], cat:'iSpecial',
  ...
  {id:32, name:'Спа-лист', price:200, vb:[0,-960,960,960], cat:'iSpecial',
  ...
  {id:33, name:'Эко-лист', price:200, vb:[0,-960,960,960], cat:'iSpecial',
  ...
  {id:34, name:'Размытие', price:200, vb:[0,-960,960,960], cat:'iSpecial',
  ...
  {id:35, name:'Палитра', price:200, vb:[0,-960,960,960], cat:'iSpecial',
  ...
  {id:36, name:'Робот', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:37, name:'Инженерия', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:38, name:'Биотех', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:39, name:'Наука (вектор)', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:40, name:'Психология', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:41, name:'Датчики', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:42, name:'Сетевой узел (устройства)', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:43, name:'Зарядка', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:44, name:'Разряд', price:150, vb:[0,-960,960,960], cat:'iTech',
    svg:'M400-80v-320H280v-480h400l-80 280h160L400-80Z'},
  {id:45, name:'Точное производство', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:46, name:'Радар', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:47, name:'Замок', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:48, name:'Открытый замок', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:49, name:'Ключ-VPN', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:50, name:'Ключ', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:51, name:'Отпечаток', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:52, name:'Шифрование', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:53, name:'Возможная угроза', price:150, vb:[0,-960,960,960], cat:'iSecrets',
  ...
  {id:54, name:'Конфетти', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:55, name:'Фестиваль', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:56, name:'Ночная жизнь', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:57, name:'Подарок-приз', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:58, name:'Инвентарь', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:59, name:'Жетон (вектор)', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:60, name:'Оплачено', price:150, vb:[0,-960,960,960], cat:'iParty',
    svg:'M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Z'},
  {id:61, name:'Сбережения', price:150, vb:[0,-960,960,960], cat:'iParty',
  ...
  {id:62, name:'Парусник', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:63, name:'Якорь (вектор)', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:64, name:'Лодка', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:65, name:'Сёрфинг', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:66, name:'Каякинг', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:67, name:'Дайвинг', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:68, name:'Цунами', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:69, name:'Пляж', price:150, vb:[0,-960,960,960], cat:'iSea',
  ...
  {id:70, name:'Парк', price:100, vb:[0,-960,960,960], cat:'iNature',
    svg:'M558-80H402v-160H120l160-240h-80l280-400 280 400h-80l160 240H558v160Z'},
  {id:71, name:'Лес', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:72, name:'Природа (вектор)', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:73, name:'Трава', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:74, name:'Компост', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:75, name:'Взлёт', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:76, name:'Посадка', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:77, name:'Воздушный узел', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:78, name:'Спутник (простой)', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:79, name:'Ракета (простая)', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:80, name:'Замок-крепость', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:81, name:'Флаг (вектор)', price:200, vb:[0,-960,960,960], cat:'iStatus',
    svg:'M200-120v-680h360l16 80h224v400H520l-16-80H280v280h-80Z'},
  {id:82, name:'Звезда (вектор)', price:200, vb:[0,-960,960,960], cat:'iStatus',
    svg:'m233-120 65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Z'},
  {id:83, name:'Полузвезда', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:84, name:'Движение-сияние', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:85, name:'Солнце (вектор)', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:86, name:'Светлый режим', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:87, name:'Тёмный режим', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:88, name:'Облачная дымка', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:89, name:'Вода (вектор)', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:90, name:'Потоп', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:91, name:'Яркость высокая', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:92, name:'Яркость низкая', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:93, name:'Яркость средняя', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:94, name:'Круговое размытие', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:95, name:'Туман (вектор)', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:96, name:'Переменная облачность', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:97, name:'Ясный день', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:98, name:'Буря', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:99, name:'Высокая влажность', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:100, name:'Разведка', price:150, vb:[0,-960,960,960], cat:'iExplore',
    svg:'m260-260 300-140 140-300-300 140-140 300Zm220-180q-17 0-28.5-11.5T440-480q0-17 11.5-28.5T480-520q17 0 28.5 11.5T520-480q0 17-11.5 28.5T480-440Zm0 360q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Z'},
  {id:101, name:'Поход', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:102, name:'Рюкзак', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:103, name:'Калибровка компаса', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:104, name:'Навигация', price:150, vb:[0,-960,960,960], cat:'iExplore',
    svg:'m200-120-40-40 320-720 320 720-40 40-280-120-280 120Z'},
  {id:105, name:'Курс на меня', price:150, vb:[0,-960,960,960], cat:'iExplore',
    svg:'M516-120 402-402 120-516v-56l720-268-268 720h-56Z'},
  {id:106, name:'Моё место', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:107, name:'Добавить точку', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:108, name:'Улей', price:150, vb:[0,-960,960,960], cat:'iExplore',
  ...
  {id:109, name:'Преданность', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:110, name:'Часы (вектор)', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:111, name:'Полиция (значок)', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:112, name:'Щит-луна', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:113, name:'Спортивный счёт', price:250, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:114, name:'Таблица лидеров', price:250, vb:[0,-960,960,960], cat:'iStatus',
    svg:'M80-120v-480h220v480H80Zm290 0v-720h220v720H370Zm290 0v-400h220v400H660Z'},
  {id:115, name:'Цветок (вектор)', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:116, name:'Винтажный цветок', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:117, name:'Растение в горшке', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:118, name:'Природа и люди', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:119, name:'Питомец', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:120, name:'Без жестокости (заяц)', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:121, name:'Яйцо', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:122, name:'Жук-отчёт', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:123, name:'Электро-разряд', price:150, vb:[0,-960,960,960], cat:'iTech',
    svg:'m280-80 160-300-320-40 480-460h80L520-580l320 40L360-80h-80Z'},
  {id:124, name:'Автономный разряд', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:125, name:'Батарея полная', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:126, name:'Роутер', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:127, name:'Плата разработчика', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:128, name:'Кабель', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:129, name:'DNS-узел', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:130, name:'Раздача Wi-Fi', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:131, name:'Глобальный поиск', price:150, vb:[0,-960,960,960], cat:'iTech',
    svg:'M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q146 0 255.5 91.5T872-559h-82q-19-73-68.5-130.5T600-776v16q0 33-23.5 56.5T520-680h-80v80q0 17-11.5 28.5T400-560h-80v80h80v120h-40L168-552q-3 18-5.5 36t-2.5 36q0 131 92 225t228 95v80Zm364-20L716-228q-21 12-45 20t-51 8q-75 0-127.5-52.5T440-380q0-75 52.5-127.5T620-560q75 0 127.5 52.5T800-380q0 27-8 51t-20 45l128 128-56 56ZM620-280q42 0 71-29t29-71q0-42-29-71t-71-29q-42 0-71 29t-29 71q0 42 29 71t71 29Z'},
  {id:132, name:'Язык/сеть', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:133, name:'Дерево связей', price:150, vb:[0,-960,960,960], cat:'iTech',
    svg:'M600-120v-120H440v-400h-80v120H80v-320h280v120h240v-120h280v320H600v-120h-80v320h80v-120h280v320H600Z'},
  {id:134, name:'Поделиться', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:135, name:'Проверка сети', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:136, name:'Вышка связи', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:137, name:'Мозаика сияния', price:200, vb:[0,-960,960,960], cat:'iMagic',
  ...
  {id:138, name:'Градиент', price:200, vb:[0,-960,960,960], cat:'iMagic',
  ...
  {id:139, name:'Кисть', price:200, vb:[0,-960,960,960], cat:'iMagic',
  ...
  {id:140, name:'Заливка цветом', price:200, vb:[0,-960,960,960], cat:'iMagic',
  ...
  {id:141, name:'Пипетка цвета', price:200, vb:[0,-960,960,960], cat:'iMagic',
  ...
  {id:142, name:'Ночной режим', price:150, vb:[0,-960,960,960], cat:'iNight',
  ...
  {id:143, name:'Сон', price:150, vb:[0,-960,960,960], cat:'iNight',
  ...
  {id:144, name:'Невидимость', price:150, vb:[0,-960,960,960], cat:'iNight',
    svg:'M792-56 624-222q-35 11-70.5 16.5T480-200q-151 0-269-83.5T40-500q21-53 53-98.5t73-81.5L56-792l56-56 736 736-56 56ZM480-320q11 0 20.5-1t20.5-4L305-541q-3 11-4 20.5t-1 20.5q0 75 52.5 127.5T480-320Zm292 18L645-428q7-17 11-34.5t4-37.5q0-75-52.5-127.5T480-680q-20 0-37.5 4T408-664L306-766q41-17 84-25.5t90-8.5q151 0 269 83.5T920-500q-23 59-60.5 109.5T772-302ZM587-486 467-606q28-5 51.5 4.5T559-574q17 18 24.5 41.5T587-486Z'},
  {id:145, name:'Контраст', price:150, vb:[0,-960,960,960], cat:'iNight',
  ...
  {id:146, name:'Расписание', price:100, vb:[0,-960,960,960], cat:'iTime',
  ...
  {id:150, name:'Песочные часы (начало)', price:100, vb:[0,-960,960,960], cat:'iTime',
  ...
  {id:151, name:'Песочные часы (конец)', price:100, vb:[0,-960,960,960], cat:'iTime',
  ...
  {id:152, name:'Таймер', price:100, vb:[0,-960,960,960], cat:'iTime',
  ...
  {id:153, name:'Будильник (вектор)', price:100, vb:[0,-960,960,960], cat:'iTime',
  ...
  {id:154, name:'Подкаст-сигнал', price:150, vb:[0,-960,960,960], cat:'iSignals',
  ...
  {id:155, name:'RSS-лента', price:150, vb:[0,-960,960,960], cat:'iSignals',
  ...
  {id:156, name:'Антенна-настройка', price:150, vb:[0,-960,960,960], cat:'iSignals',
  ...
  {id:157, name:'Уровень сигнала', price:150, vb:[0,-960,960,960], cat:'iSignals',
    svg:'M200-160v-240h120v240H200Zm240 0v-440h120v440H440Zm240 0v-640h120v640H680Z'},
  {id:158, name:'Wi-Fi', price:150, vb:[0,-960,960,960], cat:'iSignals',
  ...
  {id:159, name:'Инструмент', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:160, name:'Мастер на все руки', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:161, name:'Стройка', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:162, name:'Плотник', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:163, name:'Сантехника', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:164, name:'Ремонтная служба', price:100, vb:[0,-960,960,960], cat:'iTools',
  ...
  {id:165, name:'Зерно/шум', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:166, name:'Точечный узор', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:167, name:'Линейное размытие', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:168, name:'Текстура', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:169, name:'Шестиугольник', price:150, vb:[0,-960,960,960], cat:'iAbstract',
    svg:'M272-120 64-480l208-360h416l208 360-208 360H272Z'},
  {id:170, name:'Категория-фигуры', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:171, name:'Цветок-звено', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:172, name:'Горный пейзаж', price:150, vb:[0,-960,960,960], cat:'iAbstract',
    svg:'m40-240 240-320 180 240h101L410-520l150-200 360 480H40Z'},
  {id:173, name:'Спица-луч', price:150, vb:[0,-960,960,960], cat:'iAbstract',
  ...
  {id:174, name:'Жара', price:150, vb:[0,-960,960,960], cat:'iElem',
    svg:'M160-400q0-105 50-187t110-138q60-56 110-85.5l50-29.5v132q0 37 25 58.5t56 21.5q17 0 32.5-7t28.5-23l18-22q72 42 116 116.5T800-400q0 88-43 160.5T644-125q17-24 26.5-52.5T680-238q0-40-15-75.5T622-377L480-516 339-377q-29 29-44 64t-15 75q0 32 9.5 60.5T316-125q-70-42-113-114.5T160-400Zm320-4 85 83q17 17 26 38t9 45q0 49-35 83.5T480-120q-50 0-85-34.5T360-238q0-23 9-44.5t26-38.5l85-83Z'},
  {id:175, name:'Тепловой насос', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:176, name:'Термостат', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:177, name:'Раскалено', price:150, vb:[0,-960,960,960], cat:'iElem',
  ...
  {id:178, name:'Двор', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:179, name:'Терраса', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:180, name:'Забор', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:181, name:'Коттедж', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:182, name:'Дачный посёлок', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:183, name:'Хижина', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:184, name:'Полёт (вектор)', price:150, vb:[0,-960,960,960], cat:'iFlight',
  ...
  {id:185, name:'Авиалинии', price:150, vb:[0,-960,960,960], cat:'iFlight',
    svg:'m80-160 440-640h360L760-160H80Zm500-240q42 0 71-29t29-71q0-42-29-71t-71-29q-42 0-71 29t-29 71q0 42 29 71t71 29Z'},
  {id:186, name:'Открытая книга', price:200, vb:[0,-960,960,960], cat:'iMind',
  ...
  {id:187, name:'Книга-меню', price:200, vb:[0,-960,960,960], cat:'iMind',
  ...
  {id:188, name:'Историческое знание', price:200, vb:[0,-960,960,960], cat:'iMind',
  ...
  {id:189, name:'Психология (альт.)', price:200, vb:[0,-960,960,960], cat:'iMind',
  ...
  {id:190, name:'Саморазвитие', price:200, vb:[0,-960,960,960], cat:'iMind',
  ...
  {id:191, name:'Эквалайзер', price:150, vb:[0,-960,960,960], cat:'iSound',
  ...
  {id:192, name:'Эквалайзер (столбцы)', price:150, vb:[0,-960,960,960], cat:'iSound',
    svg:'M160-160v-320h160v320H160Zm240 0v-640h160v640H400Zm240 0v-440h160v440H640Z'},
  {id:193, name:'Объёмный звук', price:150, vb:[0,-960,960,960], cat:'iSound',
  ...
  {id:194, name:'Пространственный звук', price:150, vb:[0,-960,960,960], cat:'iSound',
  ...
  {id:195, name:'Мотоцикл', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:196, name:'Электромобиль', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:197, name:'Заправка для электро', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:198, name:'Грузовик', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:199, name:'Трамвай', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:200, name:'Метро', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:201, name:'Велосипед', price:150, vb:[0,-960,960,960], cat:'iVehicles',
  ...
  {id:202, name:'Казино', price:100, vb:[0,-960,960,960], cat:'iGames',
  ...
  {id:203, name:'Пазл', price:100, vb:[0,-960,960,960], cat:'iGames',
  ...
  {id:204, name:'Игровой контроллер', price:100, vb:[0,-960,960,960], cat:'iGames',
  ...
  {id:205, name:'Игрушки', price:100, vb:[0,-960,960,960], cat:'iGames',
  ...
  {id:206, name:'Облако', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:207, name:'Облако-загрузка', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:208, name:'Облако-скачивание', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:209, name:'Облако-контур', price:100, vb:[0,0,24,24], cat:'iSky',
  ...
  {id:210, name:'Облако-готово', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:211, name:'Облако в круге', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:212, name:'Ночной светильник', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:213, name:'Град', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:214, name:'Зонт', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:215, name:'Сильный холод', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:216, name:'Воздух', price:100, vb:[0,-960,960,960], cat:'iSky',
  ...
  {id:217, name:'Пейзаж', price:100, vb:[0,-960,960,960], cat:'iNature',
    svg:'m40-240 240-320 180 240h101L410-520l150-200 360 480H40Z'},
  {id:218, name:'Земледелие', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:219, name:'Эко-энергия', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:220, name:'Природа-эмблема', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:221, name:'Переработка', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:222, name:'Молекула CO2', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:223, name:'Оползень', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:224, name:'Камин', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:225, name:'Ветряк', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:226, name:'Солнечная батарея', price:100, vb:[0,-960,960,960], cat:'iNature',
  ...
  {id:227, name:'Горные лыжи', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:228, name:'Сноуборд', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:229, name:'Снегоступы', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:230, name:'Санки', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:231, name:'Снегоход', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:232, name:'Параплан', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:233, name:'Кайтсёрфинг', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:234, name:'Гребля', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:235, name:'Бассейн', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:236, name:'Дом на воде', price:150, vb:[0,-960,960,960], cat:'iAdventure',
  ...
  {id:237, name:'Указатель', price:150, vb:[0,-960,960,960], cat:'iAdventure',
    svg:'M440-80v-160H240L120-360l120-120h200v-80H160v-240h280v-80h80v80h200l120 120-120 120H520v80h280v240H520v160h-80Z'},
  {id:238, name:'Шале', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:239, name:'Крепость', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:240, name:'Многоэтажка', price:100, vb:[0,-960,960,960], cat:'iHomes',
    svg:'M120-120v-560h160v-160h400v320h160v400H520v-160h-80v160H120Zm80-80h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm160 160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm160 320h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm160 480h80v-80h-80v80Zm0-160h80v-80h-80v80Z'},
  {id:241, name:'Здание-офис', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:242, name:'Завод', price:100, vb:[0,-960,960,960], cat:'iHomes',
  ...
  {id:243, name:'Андроид', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:244, name:'Хранилище', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:245, name:'Фонарик', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:246, name:'Пульс-монитор', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:247, name:'Бесконечность (кольца)', price:150, vb:[0,-960,960,960], cat:'iTech',
    svg:'M220-260q-92 0-156-64T0-480q0-92 64-156t156-64q37 0 71 13t61 37l68 62-60 54-62-56q-16-14-36-22t-42-8q-58 0-99 41t-41 99q0 58 41 99t99 41q22 0 42-8t36-22l310-280q27-24 61-37t71-13q92 0 156 64t64 156q0 92-64 156t-156 64q-37 0-71-13t-61-37l-68-62 60-54 62 56q16 14 36 22t42 8q58 0 99-41t41-99q0-58-41-99t-99-41q-22 0-42 8t-36 22L352-310q-27 24-61 37t-71 13Z'},
  {id:248, name:'Радио', price:150, vb:[0,-960,960,960], cat:'iTech',
  ...
  {id:249, name:'Бейдж', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:250, name:'Аналитика-вспышка', price:200, vb:[0,0,24,24], cat:'iStatus',
  ...
  {id:251, name:'Оповещение-рупор', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:252, name:'Закладка', price:200, vb:[0,-960,960,960], cat:'iStatus',
    svg:'M200-120v-640q0-33 23.5-56.5T280-840h400q33 0 56.5 23.5T760-760v640L480-240 200-120Z'},
  {id:253, name:'Новинка-звезда', price:200, vb:[0,-960,960,960], cat:'iStatus',
    svg:'m344-60-76-128-144-32 14-148-98-112 98-112-14-148 144-32 76-128 136 58 136-58 76 128 144 32-14 148 98 112-98 112 14 148-144 32-76 128-136-58-136 58Zm94-278 226-226-56-58-170 170-86-84-56 56 142 142Z'},
  {id:254, name:'Опасно', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:255, name:'Щит-политика', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:256, name:'Подсказка приватности', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:257, name:'Ярлык', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:258, name:'Токен', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:259, name:'Улучшение камеры', price:200, vb:[0,0,24,24], cat:'iStatus',
  ...
  {id:260, name:'Сигнал SOS', price:200, vb:[0,-960,960,960], cat:'iStatus',
  ...
  {id:261, name:'Багаж', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:262, name:'Авиабилет', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:263, name:'Колесо аттракциона', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:264, name:'Панорама', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:265, name:'Театральные маски', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:266, name:'Гриль на природе', price:150, vb:[0,-960,960,960], cat:'iTravel',
  ...
  {id:267, name:'Торт', price:150, vb:[0,-960,960,960], cat:'iTravel',
...
const FLASHES=[
  ...
  {id:1, name:'Кольцо', price:500, style:'ring'},
  {id:2, name:'Звёздный всплеск', price:500, style:'star'},
  {id:3, name:'Всплеск частиц', price:500, style:'particles'},
  {id:4, name:'Крестовина', price:500, style:'cross'},
  {id:5, name:'Двойное кольцо', price:650, style:'doublering'},
  {id:6, name:'Вихрь', price:650, style:'spiral'},
  {id:7, name:'Ударная волна', price:650, style:'shockwave'},
  {id:8, name:'Сфера-вспышка', price:800, style:'sphere'},
  {id:9, name:'Затмение', price:800, style:'eclipse'},
  {id:10, name:'Молния', price:800, style:'lightning'},
];
...
const S = {
  ...
  icon:0, ownedIcons:[0], // 29.08.2026 «правая сторона, отдельная категория»: та же пара, что у decal/ownedDecals, но свой слот — носится одновременно с decal, не вместо
  ...
  launchFx:0, ownedLaunchFx:[0], // третий независимый слот — та же пара, что у decal/icon
  favDecal:[], favIcon:[], favLaunchFx:[], // 29.08.2026 «избранное»: до 2 id на категорию, только среди уже надетых (см. ui.js:angarToggleFav)
