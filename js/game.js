...
const SKINS=[ // 10.09.2026: переставлено и разбито на 8 тем + classic (id0), владелец — «чтобы удобно смотреть и выбирать»
  ...
  {id:66, name:'Фигуры Лихтенберга — позитивный', price:100, extra:true, fx:'cosLichtPos', body:'#dceeff',fold:'#8fbfe8',glow:'rgba(100,180,240,.95)',trail:'rgba(100,180,240,', cat:'physics', fact:'Настоящее ветвящееся дерево (модель диэлектрического пробоя Нимайер-Пьетронеро-Вайсман, 1984) реально прорастает волной от центра к краю'},
  ...
  {id:70, name:'Сонолюминесценция',              price:100, extra:true, fx:'cosSono',     body:'#e0f4ff',fold:'#a0d0e8',glow:'rgba(140,210,240,.95)',trail:'rgba(140,210,240,', cat:'physics', fact:'Пузырёк расширяется в ~10 раз (4.5→45 микрон), затем резко схлопывается — вспышка света ровно в момент коллапса'},
  ...
  {id:58, name:'Квазикристалл — дифракция',    price:100, extra:true, fx:'cosQuasi',    body:'#dcf6ff',fold:'#7fd0e8',glow:'rgba(70,200,230,.95)', trail:'rgba(70,200,230,', cat:'optics', fact:'10 лучей ровно через 36°, радиусы соседних пятен растут в φ=1.618 раз — та самая картина, которую предсказала математика Пенроуза до открытия Шехтмана (1982)'},
  ...
  {id:69, name:'Филлотаксис — золотой угол',     price:100, extra:true, fx:'cosPhyllo',   body:'#fff3d6',fold:'#e0c080',glow:'rgba(230,190,90,.95)', trail:'rgba(230,190,90,', cat:'biology', fact:'Настоящая формула подсолнечника (Фогель, 1979): r=√n, θ=n·137.5077° — семена появляются одно за другим, не готовым узором'},
  ...
  {id:78, name:'Навахо — Crystal', price:100, extra:true, fx:'culNavajoCrystal', body:'#9c8a5a',fold:'#4a3f28',glow:'rgba(180,160,110,.95)', trail:'rgba(180,160,110,', cat:'textile', fact:'Приглушённые растительные красители, полосы без каймы реально нарастают рядами'},
