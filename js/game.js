...
const SKINS=[ // 10.09.2026: переставлено и разбито на 8 тем + classic (id0), владелец — «чтобы удобно смотреть и выбирать»
  ...
  {id:148, name:'Динофлагелляты', price:100, extra:true, fx:'bioLumDinoflagellate', body:'#0c1420',fold:'#3a90c0',glow:'rgba(100,200,230,.9)', trail:'rgba(100,200,230,', cat:'biology', fact:'Вспышка одноклеточных динофлагеллят запускается сдвиговым возмущением воды — по одной из гипотез, это сигнал тревоги, отпугивающий хищника хищника'},
