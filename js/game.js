...
const SKINS=[ // v1.44.0: палитра разведена по цветовому кругу — соседи больше не близнецы
  ...
  {id:109, name:'Гофра — профиль C', price:100, extra:true, fx:'matCorrugC', body:'#c9a26c',fold:'#a67c47',glow:'rgba(240,165,40,.95)', trail:'rgba(240,165,40,', cat:'culture', fact:'Настоящий отраслевой профиль гофрокартона C: длина волны 7.82мм, отношение высоты к длине волны 0.512 — сверено по 2 независимым источникам'}, // 10.09.2026 (владелец: «свет сливается с корпусом») — glow разведён: был почти тем же тоном, что body, теперь насыщенный янтарь
  {id:110, name:'Слоистая ламинация', price:100, extra:true, fx:'matLayeredLam', body:'#b8895a',fold:'#8f6438',glow:'rgba(200,90,50,.95)', trail:'rgba(200,90,50,', cat:'culture', fact:'Стилизация техники папье-крафта: форма набрана стопкой плоских срезов-контуров, каждый шов — настоящая граница между слоями'}, // 10.09.2026: glow — медный срез, не копия карамельного корпуса
  {id:111, name:'Стальная стенка балки', price:100, extra:true, fx:'matSteelWall', body:'#8a94a0',fold:'#69737e',glow:'rgba(90,190,225,.95)', trail:'rgba(90,190,225,', cat:'culture', fact:'Реальная гофрированная стенка балки (рецензируемая статья MDPI Materials): волна заметно площе гофрокартона — отношение высоты к длине волны всего 0.14-0.18'}, // 10.09.2026: glow — холодный циан-блик металла, не серая копия корпуса
  {id:112, name:'Металлический сильфон', price:100, extra:true, fx:'matBellows', body:'#b6c0ca',fold:'#8892a0',glow:'rgba(180,225,255,.98)', trail:'rgba(180,225,255,', cat:'culture', fact:'Реальный компенсатор US Bellows: высота 13мм, шаг 15мм — отношение 0.867, почти квадратная волна, честно U-профиль, а не синусоида'}, // 10.09.2026: glow — яркий ледяной блик отполированного металла, не серая копия корпуса
