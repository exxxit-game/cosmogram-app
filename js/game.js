...
const SKINS=[ // v1.44.0: палитра разведена по цветовому кругу — соседи больше не близнецы
  ...
  {id:9,  name:'Спиральная галактика',       price:100, premium:true, fx:'cosGalaxy',    body:'#dde6ff',fold:'#9aa8e0',glow:'rgba(120,150,255,.95)',trail:'rgba(120,150,255,', cat:'stars'}, // Волна плотности вращается как целое (Лин-Шу), не звёзды по отдельности
  {id:10, name:'Аккреционный диск',          price:100, premium:true, fx:'cosAccretion', body:'#f4f2ff',fold:'#c9c3ea',glow:'rgba(210,200,255,.95)',trail:'rgba(210,200,255,', cat:'stars'}, // Кеплеровская дифф. ротация + турбулентно мерцающий джет
  {id:11, name:'Квазикристалл',              price:100, premium:true, fx:'cosQuasi',     body:'#ffe0ec',fold:'#e592b0',glow:'rgba(255,90,140,.95)', trail:'rgba(255,90,140,', cat:'stars'},  // Апериодичная диаграмма дифракции, 10-лучевая симметрия
  {id:12, name:'Дамасская сталь',            price:100, premium:true, fx:'matWootz',     body:'#fff0d6',fold:'#e0b46a',glow:'rgba(230,170,70,.95)', trail:'rgba(230,170,70,', cat:'stars'},  // Вуц — блеск бежит по волнистым полосам «воды»
  {id:13, name:'Кольчуга',                   price:100, premium:true, fx:'chainmail6',   body:'#d8ffe8',fold:'#8ed9ac',glow:'rgba(70,220,130,.95)', trail:'rgba(70,220,130,', cat:'stars'},  // 6-в-1, полотно реально собирается кольцо за кольцом
  {id:14, name:'Персидский ковёр',           price:100, premium:true, fx:'persianTabriz',body:'#d2f6ff',fold:'#7fc9e0',glow:'rgba(60,190,230,.95)', trail:'rgba(60,190,230,', cat:'stars'},  // Тебриз — ткётся узел за узлом снизу вверх
