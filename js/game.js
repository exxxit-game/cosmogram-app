...
const DECALS=[
  ...
  // Космос
  {id:1, name:'Ракета', price:0, ch:'🚀', cat:'space'}, {id:2, name:'Тарелка', price:0, ch:'🛸', cat:'space'}, // 29.08.2026: бесплатны, заполняют пустые клетки у «Без украшений» — см. ANGAR_FREEBIE (ui.js)
...
const ICONS=[
  ...
  {id:1, name:'Ракета (вектор)', price:0, vb:[0,-960,960,960], cat:'iBasic', // 29.08.2026: бесплатна — см. ANGAR_FREEBIE (ui.js)
  ...
  {id:2, name:'Медаль (вектор)', price:0, vb:[0,-960,960,960], cat:'iBasic', // 29.08.2026: бесплатна — см. ANGAR_FREEBIE (ui.js)
