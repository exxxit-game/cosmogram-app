...
const DECALS=[
  ...
  {id:981, name:'Тающее лицо', price:80, ch:'🫠', cat:'faces'},
  {id:982, name:'Лицо с ладонью у рта', price:80, ch:'🫢', cat:'faces'},
  {id:983, name:'Подглядывающее лицо', price:80, ch:'🫣', cat:'faces'},
  {id:984, name:'Отдающее честь лицо', price:80, ch:'🫡', cat:'faces'},
  {id:985, name:'Пунктирное лицо', price:80, ch:'🫥', cat:'faces'},
  {id:986, name:'Лицо в тумане', price:80, ch:'😶‍🌫️', cat:'faces'},
  {id:987, name:'Выдыхающее лицо', price:80, ch:'😮‍💨', cat:'faces'},
  {id:988, name:'Дрожащее лицо', price:80, ch:'🫨', cat:'faces'},
  {id:989, name:'Кивок «нет»', price:80, ch:'🙂‍↔️', cat:'faces'},
  {id:990, name:'Кивок «да»', price:80, ch:'🙂‍↕️', cat:'faces'},
  {id:991, name:'Лицо со спиралями в глазах', price:80, ch:'😵‍💫', cat:'faces'},
  {id:992, name:'Лицо с кривым ртом', price:80, ch:'🫤', cat:'faces'},
  {id:993, name:'Искажённое лицо', price:80, ch:'🫪', cat:'faces'},
  {id:994, name:'Лицо, сдерживающее слёзы', price:80, ch:'🥹', cat:'faces'},
  {id:995, name:'Лицо с символами вместо мата', price:80, ch:'🤬', cat:'faces'},
  {id:996, name:'Злое лицо с рогами', price:80, ch:'👿', cat:'faces'},
  {id:997, name:'Череп с костями', price:80, ch:'☠️', cat:'faces'},
  {id:998, name:'Любовное письмо', price:80, ch:'💌', cat:'hearts'},
  {id:999, name:'Сердце-орнамент', price:80, ch:'💟', cat:'hearts'},
  {id:1000, name:'Пылающее сердце', price:80, ch:'❤️‍🔥', cat:'hearts'},
  {id:1001, name:'Заживающее сердце', price:80, ch:'❤️‍🩹', cat:'hearts'},
  {id:1002, name:'Глаз в облаке речи', price:80, ch:'👁️‍🗨️', cat:'faces'},
  {id:1003, name:'Собака-поводырь', price:120, ch:'🐕‍🦺', cat:'animals'},
  {id:1004, name:'Чёрная кошка', price:120, ch:'🐈‍⬛', cat:'animals'},
  {id:1005, name:'Лошадь', price:120, ch:'🐎', cat:'animals'},
  {id:1006, name:'Полярный медведь', price:120, ch:'🐻‍❄️', cat:'animals'},
  {id:1007, name:'Чёрная птица', price:120, ch:'🐦‍⬛', cat:'animals'},
  {id:1008, name:'Феникс', price:350, ch:'🐦‍🔥', cat:'animals'},
  {id:1009, name:'Лайм', price:80, ch:'🍋‍🟩', cat:'food'},
  {id:1010, name:'Бобы', price:80, ch:'🫘', cat:'food'},
  {id:1011, name:'Корень имбиря', price:80, ch:'🫚', cat:'food'},
  {id:1012, name:'Стручок гороха', price:80, ch:'🫛', cat:'food'},
  {id:1013, name:'Коричневый гриб', price:80, ch:'🍄‍🟫', cat:'food'},
  {id:1014, name:'Корнеплод', price:80, ch:'🫜', cat:'food'},
  {id:1015, name:'Наливаемая жидкость', price:80, ch:'🫗', cat:'food'},
  {id:1016, name:'Банка', price:80, ch:'🫙', cat:'food'},
  {id:1017, name:'Военная медаль', price:150, ch:'🎖️', cat:'awards'},
  {id:1018, name:'Спортивная медаль', price:150, ch:'🏅', cat:'awards'},
  {id:1019, name:'Медаль за 1 место', price:150, ch:'🥇', cat:'awards'},
  {id:1020, name:'Медаль за 2 место', price:150, ch:'🥈', cat:'awards'},
  {id:1021, name:'Медаль за 3 место', price:150, ch:'🥉', cat:'awards'},
  {id:1022, name:'Зеркальный шар', price:80, ch:'🪩', cat:'games'},
  {id:1023, name:'Карта мира', price:80, ch:'🗺️', cat:'landmarks'},
  {id:1024, name:'Карта Японии', price:80, ch:'🗾', cat:'landmarks'},
  {id:1025, name:'Оползень', price:80, ch:'🛘', cat:'landmarks'},
  {id:1026, name:'Пляж с зонтом', price:80, ch:'🏖️', cat:'landmarks'},
  {id:1027, name:'Пустыня', price:80, ch:'🏜️', cat:'landmarks'},
  {id:1028, name:'Необитаемый остров', price:80, ch:'🏝️', cat:'landmarks'},
  {id:1029, name:'Национальный парк', price:80, ch:'🏞️', cat:'landmarks'},
  {id:1030, name:'Стадион', price:80, ch:'🏟️', cat:'landmarks'},
  {id:1031, name:'Античное здание', price:80, ch:'🏛️', cat:'landmarks'},
  {id:1032, name:'Стройка', price:80, ch:'🏗️', cat:'landmarks'},
  {id:1033, name:'Кирпич', price:80, ch:'🧱', cat:'landmarks'},
  {id:1034, name:'Дома', price:80, ch:'🏘️', cat:'landmarks'},
  {id:1035, name:'Заброшенный дом', price:80, ch:'🏚️', cat:'landmarks'},
  {id:1036, name:'Дом', price:80, ch:'🏠', cat:'landmarks'},
  {id:1037, name:'Дом с садом', price:80, ch:'🏡', cat:'landmarks'},
  {id:1038, name:'Офисное здание', price:80, ch:'🏢', cat:'landmarks'},
  {id:1039, name:'Японская почта', price:80, ch:'🏣', cat:'landmarks'},
  {id:1040, name:'Почта', price:80, ch:'🏤', cat:'landmarks'},
  {id:1041, name:'Больница', price:80, ch:'🏥', cat:'landmarks'},
  {id:1042, name:'Банк', price:80, ch:'🏦', cat:'landmarks'},
  {id:1043, name:'Отель', price:80, ch:'🏨', cat:'landmarks'},
  {id:1044, name:'Магазин у дома', price:80, ch:'🏪', cat:'landmarks'},
  {id:1045, name:'Школа', price:80, ch:'🏫', cat:'landmarks'},
  {id:1046, name:'Универмаг', price:80, ch:'🏬', cat:'landmarks'},
  {id:1047, name:'Завод', price:80, ch:'🏭', cat:'landmarks'},
  {id:1048, name:'Японский замок', price:80, ch:'🏯', cat:'landmarks'},
  {id:1049, name:'Замок', price:80, ch:'🏰', cat:'landmarks'},
  {id:1050, name:'Свадебная часовня', price:80, ch:'💒', cat:'landmarks'},
  {id:1051, name:'Церковь', price:80, ch:'⛪', cat:'landmarks'},
  {id:1052, name:'Мечеть', price:80, ch:'🕌', cat:'landmarks'},
  {id:1053, name:'Индуистский храм', price:80, ch:'🛕', cat:'landmarks'},
  {id:1054, name:'Синагога', price:80, ch:'🕍', cat:'landmarks'},
  {id:1055, name:'Синтоистское святилище', price:80, ch:'⛩️', cat:'landmarks'},
  {id:1056, name:'Кааба', price:80, ch:'🕋', cat:'landmarks'},
  {id:1057, name:'Туман над городом', price:80, ch:'🌁', cat:'landmarks'},
  {id:1058, name:'Ночь со звёздами', price:80, ch:'🌃', cat:'landmarks'},
  {id:1059, name:'Городской пейзаж', price:80, ch:'🏙️', cat:'landmarks'},
  {id:1060, name:'Восход над горами', price:80, ch:'🌄', cat:'landmarks'},
  {id:1061, name:'Восход', price:80, ch:'🌅', cat:'landmarks'},
  {id:1062, name:'Город в сумерках', price:80, ch:'🌆', cat:'landmarks'},
  {id:1063, name:'Закат', price:80, ch:'🌇', cat:'landmarks'},
  {id:1064, name:'Мост ночью', price:80, ch:'🌉', cat:'landmarks'},
  {id:1065, name:'Знак «Стоп»', price:60, ch:'🛑', cat:'vehicles'},
  {id:1066, name:'Подвесная железная дорога', price:60, ch:'🚟', cat:'vehicles'},
  {id:1067, name:'Горная канатная дорога', price:60, ch:'🚠', cat:'vehicles'},
  {id:1068, name:'Воздушный трамвай', price:60, ch:'🚡', cat:'vehicles'},
  {id:1069, name:'Песочные часы (закончились)', price:80, ch:'⌛', cat:'time'},
  {id:1070, name:'Песочные часы (идут)', price:80, ch:'⏳', cat:'time'},
  {id:1071, name:'Наручные часы', price:80, ch:'⌚', cat:'time'},
  {id:1072, name:'Будильник', price:80, ch:'⏰', cat:'time'},
  {id:1073, name:'Секундомер', price:80, ch:'⏱️', cat:'time'},
  {id:1074, name:'Таймер', price:80, ch:'⏲️', cat:'time'},
  {id:1075, name:'Каминные часы', price:80, ch:'🕰️', cat:'time'},
  {id:1076, name:'12:00', price:60, ch:'🕛', cat:'time'},
  {id:1077, name:'12:30', price:60, ch:'🕧', cat:'time'},
  {id:1078, name:'1:00', price:60, ch:'🕐', cat:'time'},
  {id:1079, name:'1:30', price:60, ch:'🕜', cat:'time'},
  {id:1080, name:'2:00', price:60, ch:'🕑', cat:'time'},
  {id:1081, name:'2:30', price:60, ch:'🕝', cat:'time'},
  {id:1082, name:'3:00', price:60, ch:'🕒', cat:'time'},
  {id:1083, name:'3:30', price:60, ch:'🕞', cat:'time'},
  {id:1084, name:'4:00', price:60, ch:'🕓', cat:'time'},
  {id:1085, name:'4:30', price:60, ch:'🕟', cat:'time'},
  {id:1086, name:'5:00', price:60, ch:'🕔', cat:'time'},
  {id:1087, name:'5:30', price:60, ch:'🕠', cat:'time'},
  {id:1088, name:'6:00', price:60, ch:'🕕', cat:'time'},
  {id:1089, name:'6:30', price:60, ch:'🕡', cat:'time'},
  {id:1090, name:'7:00', price:60, ch:'🕖', cat:'time'},
  {id:1091, name:'7:30', price:60, ch:'🕢', cat:'time'},
  {id:1092, name:'8:00', price:60, ch:'🕗', cat:'time'},
  {id:1093, name:'8:30', price:60, ch:'🕣', cat:'time'},
  {id:1094, name:'9:00', price:60, ch:'🕘', cat:'time'},
  {id:1095, name:'9:30', price:60, ch:'🕤', cat:'time'},
  {id:1096, name:'10:00', price:60, ch:'🕙', cat:'time'},
  {id:1097, name:'10:30', price:60, ch:'🕥', cat:'time'},
  {id:1098, name:'11:00', price:60, ch:'🕚', cat:'time'},
  {id:1099, name:'11:30', price:60, ch:'🕦', cat:'time'},
  {id:1100, name:'Падающая звезда', price:80, ch:'🌠', cat:'weather'},
  {id:1101, name:'Млечный Путь', price:80, ch:'🌌', cat:'weather'},
  {id:1102, name:'Облако', price:80, ch:'☁️', cat:'weather'},
  {id:1103, name:'Солнце за облаком', price:80, ch:'⛅', cat:'weather'},
  {id:1104, name:'Гроза', price:80, ch:'⛈️', cat:'weather'},
  {id:1105, name:'Солнце за небольшим облаком', price:80, ch:'🌤️', cat:'weather'},
  {id:1106, name:'Солнце за плотным облаком', price:80, ch:'🌥️', cat:'weather'},
  {id:1107, name:'Солнце и дождь', price:80, ch:'🌦️', cat:'weather'},
  {id:1108, name:'Дождевое облако', price:80, ch:'🌧️', cat:'weather'},
  {id:1109, name:'Снеговое облако', price:80, ch:'🌨️', cat:'weather'},
  {id:1110, name:'Облако с молнией', price:80, ch:'🌩️', cat:'weather'},
  {id:1111, name:'Туман', price:80, ch:'🌫️', cat:'weather'},
  {id:1112, name:'Закрытый зонт', price:80, ch:'🌂', cat:'weather'},
  {id:1113, name:'Зонт', price:80, ch:'☂️', cat:'weather'},
  {id:1114, name:'Зонт под дождём', price:80, ch:'☔', cat:'weather'},
  {id:1115, name:'Пляжный зонт', price:80, ch:'⛱️', cat:'weather'},
  {id:1116, name:'Очки', price:80, ch:'👓', cat:'fashion'},
  {id:1117, name:'Защитные очки', price:80, ch:'🥽', cat:'fashion'},
  {id:1118, name:'Лабораторный халат', price:80, ch:'🥼', cat:'fashion'},
  {id:1119, name:'Светоотражающий жилет', price:80, ch:'🦺', cat:'fashion'},
  {id:1120, name:'Футболка', price:80, ch:'👕', cat:'fashion'},
  {id:1121, name:'Джинсы', price:80, ch:'👖', cat:'fashion'},
  {id:1122, name:'Шарф', price:80, ch:'🧣', cat:'fashion'},
  {id:1123, name:'Перчатки', price:80, ch:'🧤', cat:'fashion'},
  {id:1124, name:'Пальто', price:80, ch:'🧥', cat:'fashion'},
  {id:1125, name:'Носки', price:80, ch:'🧦', cat:'fashion'},
  {id:1126, name:'Платье', price:80, ch:'👗', cat:'fashion'},
  {id:1127, name:'Кимоно', price:80, ch:'👘', cat:'fashion'},
  {id:1128, name:'Сари', price:80, ch:'🥻', cat:'fashion'},
  {id:1129, name:'Купальник', price:80, ch:'🩱', cat:'fashion'},
  {id:1130, name:'Плавки', price:80, ch:'🩲', cat:'fashion'},
  {id:1131, name:'Шорты', price:80, ch:'🩳', cat:'fashion'},
  {id:1132, name:'Бикини', price:80, ch:'👙', cat:'fashion'},
  {id:1133, name:'Женская одежда', price:80, ch:'👚', cat:'fashion'},
  {id:1134, name:'Складной веер', price:80, ch:'🪭', cat:'fashion'},
  {id:1135, name:'Кошелёк', price:80, ch:'👛', cat:'fashion'},
  {id:1136, name:'Сумочка', price:80, ch:'👜', cat:'fashion'},
  {id:1137, name:'Клатч', price:80, ch:'👝', cat:'fashion'},
  {id:1138, name:'Пакеты с покупками', price:80, ch:'🛍️', cat:'fashion'},
  {id:1139, name:'Рюкзак', price:80, ch:'🎒', cat:'fashion'},
  {id:1140, name:'Вьетнамки', price:80, ch:'🩴', cat:'fashion'},
  {id:1141, name:'Мужской ботинок', price:80, ch:'👞', cat:'fashion'},
  {id:1142, name:'Треккинговый ботинок', price:80, ch:'🥾', cat:'fashion'},
  {id:1143, name:'Балетка', price:80, ch:'🥿', cat:'fashion'},
  {id:1144, name:'Туфля на каблуке', price:80, ch:'👠', cat:'fashion'},
  {id:1145, name:'Женская сандалия', price:80, ch:'👡', cat:'fashion'},
  {id:1146, name:'Пуанты', price:80, ch:'🩰', cat:'fashion'},
  {id:1147, name:'Женский сапог', price:80, ch:'👢', cat:'fashion'},
  {id:1148, name:'Расчёска-гребень', price:80, ch:'🪮', cat:'fashion'},
  {id:1149, name:'Женская шляпа', price:80, ch:'👒', cat:'fashion'},
  {id:1150, name:'Академическая шапочка', price:80, ch:'🎓', cat:'fashion'},
  {id:1151, name:'Динамик без звука', price:60, ch:'🔇', cat:'music'},
  {id:1152, name:'Тихий динамик', price:60, ch:'🔈', cat:'music'},
  {id:1153, name:'Динамик средней громкости', price:60, ch:'🔉', cat:'music'},
  {id:1154, name:'Громкий динамик', price:60, ch:'🔊', cat:'music'},
  {id:1155, name:'Громкоговоритель', price:60, ch:'📢', cat:'music'},
  {id:1156, name:'Мегафон', price:60, ch:'📣', cat:'music'},
  {id:1157, name:'Почтовый рожок', price:60, ch:'📯', cat:'music'},
  {id:1158, name:'Колокольчик', price:60, ch:'🔔', cat:'music'},
  {id:1159, name:'Нотный лист', price:60, ch:'🎼', cat:'music'},
  {id:1160, name:'Ноты', price:60, ch:'🎶', cat:'music'},
  {id:1161, name:'Студийный микрофон', price:60, ch:'🎙️', cat:'music'},
  {id:1162, name:'Микшерный слайдер', price:60, ch:'🎚️', cat:'music'},
  {id:1163, name:'Ручки настройки', price:60, ch:'🎛️', cat:'music'},
  {id:1164, name:'Микрофон', price:60, ch:'🎤', cat:'music'},
  {id:1165, name:'Радио', price:60, ch:'📻', cat:'music'},
  {id:1166, name:'Тромбон', price:60, ch:'🪊', cat:'music'},
  {id:1167, name:'Аккордеон', price:60, ch:'🪗', cat:'music'},
  {id:1168, name:'Банджо', price:60, ch:'🪕', cat:'music'},
  {id:1169, name:'Африканский барабан', price:60, ch:'🪘', cat:'music'},
  {id:1170, name:'Маракасы', price:60, ch:'🪇', cat:'music'},
  {id:1171, name:'Флейта', price:60, ch:'🪈', cat:'music'},
  {id:1172, name:'Арфа', price:60, ch:'🪉', cat:'music'},
  {id:1173, name:'Мобильный телефон', price:80, ch:'📱', cat:'tech'},
  {id:1174, name:'Телефон', price:80, ch:'☎️', cat:'tech'},
  {id:1175, name:'Телефонная трубка', price:80, ch:'📞', cat:'tech'},
  {id:1176, name:'Пейджер', price:80, ch:'📟', cat:'tech'},
  {id:1177, name:'Факс', price:80, ch:'📠', cat:'tech'},
  {id:1178, name:'Разряженная батарея', price:80, ch:'🪫', cat:'tech'},
  {id:1179, name:'Электровилка', price:80, ch:'🔌', cat:'tech'},
  {id:1180, name:'Настольный компьютер', price:80, ch:'🖥️', cat:'tech'},
  {id:1181, name:'Принтер', price:80, ch:'🖨️', cat:'tech'},
  {id:1182, name:'Клавиатура', price:80, ch:'⌨️', cat:'tech'},
  {id:1183, name:'Компьютерная мышь', price:80, ch:'🖱️', cat:'tech'},
  {id:1184, name:'Трекбол', price:80, ch:'🖲️', cat:'tech'},
  {id:1185, name:'Жёсткий диск', price:80, ch:'💽', cat:'tech'},
  {id:1186, name:'Дискета', price:80, ch:'💾', cat:'tech'},
  {id:1187, name:'CD-диск', price:80, ch:'💿', cat:'tech'},
  {id:1188, name:'DVD-диск', price:80, ch:'📀', cat:'tech'},
  {id:1189, name:'Счёты', price:80, ch:'🧮', cat:'tech'},
  {id:1190, name:'Кинокамера', price:80, ch:'🎥', cat:'tech'},
  {id:1191, name:'Кинокадры', price:80, ch:'🎞️', cat:'tech'},
  {id:1192, name:'Кинопроектор', price:80, ch:'📽️', cat:'tech'},
  {id:1193, name:'Хлопушка', price:80, ch:'🎬', cat:'tech'},
  {id:1194, name:'Телевизор', price:80, ch:'📺', cat:'tech'},
  {id:1195, name:'Фотоаппарат со вспышкой', price:80, ch:'📸', cat:'tech'},
  {id:1196, name:'Видеокамера', price:80, ch:'📹', cat:'tech'},
  {id:1197, name:'Видеокассета', price:80, ch:'📼', cat:'tech'},
  {id:1198, name:'Лупа влево', price:80, ch:'🔍', cat:'tech'},
  {id:1199, name:'Лупа вправо', price:80, ch:'🔎', cat:'tech'},
  {id:1200, name:'Фонарик', price:80, ch:'🔦', cat:'tech'},
  {id:1201, name:'Красный фонарик', price:80, ch:'🏮', cat:'tech'},
  {id:1202, name:'Масляная лампа-дия', price:80, ch:'🪔', cat:'tech'},
  {id:1203, name:'Блокнот с узором', price:80, ch:'📔', cat:'office'},
  {id:1204, name:'Закрытая книга', price:80, ch:'📕', cat:'office'},
  {id:1205, name:'Открытая книга', price:80, ch:'📖', cat:'office'},
  {id:1206, name:'Зелёная книга', price:80, ch:'📗', cat:'office'},
  {id:1207, name:'Синяя книга', price:80, ch:'📘', cat:'office'},
  {id:1208, name:'Оранжевая книга', price:80, ch:'📙', cat:'office'},
  {id:1209, name:'Книги', price:80, ch:'📚', cat:'office'},
  {id:1210, name:'Блокнот', price:80, ch:'📓', cat:'office'},
  {id:1211, name:'Гроссбух', price:80, ch:'📒', cat:'office'},
  {id:1212, name:'Загнутая страница', price:80, ch:'📃', cat:'office'},
  {id:1213, name:'Свиток', price:80, ch:'📜', cat:'office'},
  {id:1214, name:'Лист бумаги', price:80, ch:'📄', cat:'office'},
  {id:1215, name:'Газета', price:80, ch:'📰', cat:'office'},
  {id:1216, name:'Свёрнутая газета', price:80, ch:'🗞️', cat:'office'},
  {id:1217, name:'Закладки', price:80, ch:'📑', cat:'office'},
  {id:1218, name:'Закладка', price:80, ch:'🔖', cat:'office'},
  {id:1219, name:'Ярлык', price:80, ch:'🏷️', cat:'office'},
  {id:1220, name:'Сундук с сокровищами', price:350, ch:'🪎', cat:'money'},
  {id:1221, name:'Банкнота йены', price:80, ch:'💴', cat:'money'},
  {id:1222, name:'Банкнота доллара', price:80, ch:'💵', cat:'money'},
  {id:1223, name:'Банкнота евро', price:80, ch:'💶', cat:'money'},
  {id:1224, name:'Банкнота фунта', price:80, ch:'💷', cat:'money'},
  {id:1225, name:'Улетающие деньги', price:80, ch:'💸', cat:'money'},
  {id:1226, name:'Банковская карта', price:80, ch:'💳', cat:'money'},
  {id:1227, name:'Чек', price:80, ch:'🧾', cat:'money'},
  {id:1228, name:'Растущий график с йеной', price:80, ch:'💹', cat:'money'},
  {id:1229, name:'Конверт', price:80, ch:'✉️', cat:'office'},
  {id:1230, name:'Эл. почта', price:80, ch:'📧', cat:'office'},
  {id:1231, name:'Входящее письмо', price:80, ch:'📨', cat:'office'},
  {id:1232, name:'Письмо со стрелкой', price:80, ch:'📩', cat:'office'},
  {id:1233, name:'Исходящие', price:80, ch:'📤', cat:'office'},
  {id:1234, name:'Входящие', price:80, ch:'📥', cat:'office'},
  {id:1235, name:'Посылка', price:80, ch:'📦', cat:'office'},
  {id:1236, name:'Закрытый почтовый ящик (флажок поднят)', price:80, ch:'📫', cat:'office'},
  {id:1237, name:'Закрытый почтовый ящик (флажок опущен)', price:80, ch:'📪', cat:'office'},
  {id:1238, name:'Открытый почтовый ящик (флажок поднят)', price:80, ch:'📬', cat:'office'},
  {id:1239, name:'Открытый почтовый ящик (флажок опущен)', price:80, ch:'📭', cat:'office'},
  {id:1240, name:'Почтовый ящик на улице', price:80, ch:'📮', cat:'office'},
  {id:1241, name:'Урна для голосования', price:80, ch:'🗳️', cat:'office'},
  {id:1242, name:'Карандаш', price:80, ch:'✏️', cat:'office'},
  {id:1243, name:'Чёрное перо', price:80, ch:'✒️', cat:'office'},
  {id:1244, name:'Перьевая ручка', price:80, ch:'🖋️', cat:'office'},
  {id:1245, name:'Ручка', price:80, ch:'🖊️', cat:'office'},
  {id:1246, name:'Кисть', price:80, ch:'🖌️', cat:'office'},
  {id:1247, name:'Восковой мелок', price:80, ch:'🖍️', cat:'office'},
  {id:1248, name:'Заметка', price:80, ch:'📝', cat:'office'},
  {id:1249, name:'Портфель', price:80, ch:'💼', cat:'office'},
  {id:1250, name:'Папка', price:80, ch:'📁', cat:'office'},
  {id:1251, name:'Открытая папка', price:80, ch:'📂', cat:'office'},
  {id:1252, name:'Разделители картотеки', price:80, ch:'🗂️', cat:'office'},
  {id:1253, name:'Календарь', price:80, ch:'📅', cat:'office'},
  {id:1254, name:'Отрывной календарь', price:80, ch:'📆', cat:'office'},
  {id:1255, name:'Блокнот на спирали', price:80, ch:'🗒️', cat:'office'},
  {id:1256, name:'Календарь на спирали', price:80, ch:'🗓️', cat:'office'},
  {id:1257, name:'Картотека', price:80, ch:'📇', cat:'office'},
  {id:1258, name:'Растущий график', price:80, ch:'📈', cat:'office'},
  {id:1259, name:'Падающий график', price:80, ch:'📉', cat:'office'},
  {id:1260, name:'Столбчатая диаграмма', price:80, ch:'📊', cat:'office'},
  {id:1261, name:'Планшет с зажимом', price:80, ch:'📋', cat:'office'},
  {id:1262, name:'Канцелярская кнопка', price:80, ch:'📌', cat:'office'},
  {id:1263, name:'Круглая кнопка', price:80, ch:'📍', cat:'office'},
  {id:1264, name:'Скрепка', price:80, ch:'📎', cat:'office'},
  {id:1265, name:'Скреплённые скрепки', price:80, ch:'🖇️', cat:'office'},
  {id:1266, name:'Линейка', price:80, ch:'📏', cat:'office'},
  {id:1267, name:'Чертёжный треугольник', price:80, ch:'📐', cat:'office'},
  {id:1268, name:'Ножницы', price:80, ch:'✂️', cat:'office'},
  {id:1269, name:'Ящик с картотекой', price:80, ch:'🗃️', cat:'office'},
  {id:1270, name:'Картотечный шкаф', price:80, ch:'🗄️', cat:'office'},
  {id:1271, name:'Мусорная корзина', price:80, ch:'🗑️', cat:'office'},
  {id:1272, name:'Закрытый замок', price:80, ch:'🔒', cat:'office'},
  {id:1273, name:'Открытый замок', price:80, ch:'🔓', cat:'office'},
  {id:1274, name:'Замок с ручкой', price:80, ch:'🔏', cat:'office'},
  {id:1275, name:'Замок с ключом', price:80, ch:'🔐', cat:'office'},
  {id:1276, name:'Ключ', price:80, ch:'🔑', cat:'office'},
  {id:1277, name:'Старый ключ', price:80, ch:'🗝️', cat:'office'},
  {id:1278, name:'Молоток', price:80, ch:'🔨', cat:'tools'},
  {id:1279, name:'Топор', price:80, ch:'🪓', cat:'tools'},
  {id:1280, name:'Кирка', price:80, ch:'⛏️', cat:'tools'},
  {id:1281, name:'Молоток и кирка', price:80, ch:'⚒️', cat:'tools'},
  {id:1282, name:'Молоток и гаечный ключ', price:80, ch:'🛠️', cat:'tools'},
  {id:1283, name:'Кинжал', price:80, ch:'🗡️', cat:'tools'},
  {id:1284, name:'Скрещенные мечи', price:80, ch:'⚔️', cat:'tools'},
  {id:1285, name:'Бомба', price:80, ch:'💣', cat:'tools'},
  {id:1286, name:'Бумеранг', price:80, ch:'🪃', cat:'tools'},
  {id:1287, name:'Лук со стрелой', price:80, ch:'🏹', cat:'tools'},
  {id:1288, name:'Щит', price:80, ch:'🛡️', cat:'tools'},
  {id:1289, name:'Пила', price:80, ch:'🪚', cat:'tools'},
  {id:1290, name:'Гаечный ключ', price:80, ch:'🔧', cat:'tools'},
  {id:1291, name:'Отвёртка', price:80, ch:'🪛', cat:'tools'},
  {id:1292, name:'Гайка с болтом', price:80, ch:'🔩', cat:'tools'},
  {id:1293, name:'Струбцина', price:80, ch:'🗜️', cat:'tools'},
  {id:1294, name:'Весы', price:80, ch:'⚖️', cat:'tools'},
  {id:1295, name:'Трость для слабовидящих', price:80, ch:'🦯', cat:'tools'},
  {id:1296, name:'Звено цепи', price:80, ch:'🔗', cat:'tools'},
  {id:1297, name:'Разорванная цепь', price:80, ch:'⛓️‍💥', cat:'tools'},
  {id:1298, name:'Цепь', price:80, ch:'⛓️', cat:'tools'},
  {id:1299, name:'Крюк', price:80, ch:'🪝', cat:'tools'},
  {id:1300, name:'Ящик с инструментами', price:80, ch:'🧰', cat:'tools'},
  {id:1301, name:'Лестница', price:80, ch:'🪜', cat:'tools'},
  {id:1302, name:'Лопата', price:80, ch:'🪏', cat:'tools'},
  {id:1303, name:'Шприц', price:80, ch:'💉', cat:'medical'},
  {id:1304, name:'Капля крови', price:80, ch:'🩸', cat:'medical'},
  {id:1305, name:'Таблетка', price:80, ch:'💊', cat:'medical'},
  {id:1306, name:'Пластырь', price:80, ch:'🩹', cat:'medical'},
  {id:1307, name:'Костыль', price:80, ch:'🩼', cat:'medical'},
  {id:1308, name:'Стетоскоп', price:80, ch:'🩺', cat:'medical'},
  {id:1309, name:'Рентген', price:80, ch:'🩻', cat:'medical'},
  {id:1310, name:'Дверь', price:80, ch:'🚪', cat:'household'},
  {id:1311, name:'Зеркало', price:80, ch:'🪞', cat:'household'},
  {id:1312, name:'Кровать', price:80, ch:'🛏️', cat:'household'},
  {id:1313, name:'Диван с лампой', price:80, ch:'🛋️', cat:'household'},
  {id:1314, name:'Стул', price:80, ch:'🪑', cat:'household'},
  {id:1315, name:'Туалет', price:80, ch:'🚽', cat:'household'},
  {id:1316, name:'Вантуз', price:80, ch:'🪠', cat:'household'},
  {id:1317, name:'Ванна', price:80, ch:'🛁', cat:'household'},
  {id:1318, name:'Мышеловка', price:80, ch:'🪤', cat:'household'},
  {id:1319, name:'Бритва', price:80, ch:'🪒', cat:'household'},
  {id:1320, name:'Флакон лосьона', price:80, ch:'🧴', cat:'household'},
  {id:1321, name:'Английская булавка', price:80, ch:'🧷', cat:'household'},
  {id:1322, name:'Метла', price:80, ch:'🧹', cat:'household'},
  {id:1323, name:'Корзина', price:80, ch:'🧺', cat:'household'},
  {id:1324, name:'Рулон бумаги', price:80, ch:'🧻', cat:'household'},
  {id:1325, name:'Ведро', price:80, ch:'🪣', cat:'household'},
  {id:1326, name:'Мыло', price:80, ch:'🧼', cat:'household'},
  {id:1327, name:'Мыльные пузыри', price:80, ch:'🫧', cat:'household'},
  {id:1328, name:'Зубная щётка', price:80, ch:'🪥', cat:'household'},
  {id:1329, name:'Губка', price:80, ch:'🧽', cat:'household'},
  {id:1330, name:'Огнетушитель', price:80, ch:'🧯', cat:'household'},
  {id:1331, name:'Тележка из магазина', price:80, ch:'🛒', cat:'household'},
  {id:1332, name:'Амулет-назар', price:80, ch:'🧿', cat:'household'},
  {id:1333, name:'Хамса', price:80, ch:'🪬', cat:'household'},
  {id:1334, name:'Статуя моаи', price:80, ch:'🗿', cat:'household'},
  {id:1335, name:'Табличка-плакат', price:80, ch:'🪧', cat:'household'},
  {id:1336, name:'Удостоверение личности', price:80, ch:'🪪', cat:'household'},
  {id:1337, name:'Значок банкомата', price:60, ch:'🏧', cat:'symbols'},
  {id:1338, name:'Знак «Мусор в урну»', price:60, ch:'🚮', cat:'symbols'},
  {id:1339, name:'Питьевая вода', price:60, ch:'🚰', cat:'symbols'},
  {id:1340, name:'Знак инвалидной коляски', price:60, ch:'♿', cat:'symbols'},
  {id:1341, name:'Мужской туалет', price:60, ch:'🚹', cat:'symbols'},
  {id:1342, name:'Женский туалет', price:60, ch:'🚺', cat:'symbols'},
  {id:1343, name:'Туалет', price:60, ch:'🚻', cat:'symbols'},
  {id:1344, name:'Знак «Пеленальный столик»', price:60, ch:'🚼', cat:'symbols'},
  {id:1345, name:'Знак WC', price:60, ch:'🚾', cat:'symbols'},
  {id:1346, name:'Паспортный контроль', price:60, ch:'🛂', cat:'symbols'},
  {id:1347, name:'Таможня', price:60, ch:'🛃', cat:'symbols'},
  {id:1348, name:'Выдача багажа', price:60, ch:'🛄', cat:'symbols'},
  {id:1349, name:'Камера хранения', price:60, ch:'🛅', cat:'symbols'},
  {id:1350, name:'Знак «Дети»', price:60, ch:'🚸', cat:'symbols'},
  {id:1351, name:'Въезд запрещён', price:60, ch:'⛔', cat:'symbols'},
  {id:1352, name:'Запрещено', price:60, ch:'🚫', cat:'symbols'},
  {id:1353, name:'Велосипеды запрещены', price:60, ch:'🚳', cat:'symbols'},
  {id:1354, name:'Курение запрещено', price:60, ch:'🚭', cat:'symbols'},
  {id:1355, name:'Мусорить запрещено', price:60, ch:'🚯', cat:'symbols'},
  {id:1356, name:'Вода непригодна для питья', price:60, ch:'🚱', cat:'symbols'},
  {id:1357, name:'Пешеходам вход запрещён', price:60, ch:'🚷', cat:'symbols'},
  {id:1358, name:'Телефоны запрещены', price:60, ch:'📵', cat:'symbols'},
  {id:1359, name:'18+', price:60, ch:'🔞', cat:'symbols'},
  {id:1360, name:'Стрелка вверх', price:60, ch:'⬆️', cat:'symbols'},
  {id:1361, name:'Стрелка вверх-вправо', price:60, ch:'↗️', cat:'symbols'},
  {id:1362, name:'Стрелка вправо', price:60, ch:'➡️', cat:'symbols'},
  {id:1363, name:'Стрелка вниз-вправо', price:60, ch:'↘️', cat:'symbols'},
  {id:1364, name:'Стрелка вниз', price:60, ch:'⬇️', cat:'symbols'},
  {id:1365, name:'Стрелка вниз-влево', price:60, ch:'↙️', cat:'symbols'},
  {id:1366, name:'Стрелка влево', price:60, ch:'⬅️', cat:'symbols'},
  {id:1367, name:'Стрелка вверх-влево', price:60, ch:'↖️', cat:'symbols'},
  {id:1368, name:'Стрелка вверх-вниз', price:60, ch:'↕️', cat:'symbols'},
  {id:1369, name:'Стрелка влево-вправо', price:60, ch:'↔️', cat:'symbols'},
  {id:1370, name:'Стрелка-разворот вправо-влево', price:60, ch:'↩️', cat:'symbols'},
  {id:1371, name:'Стрелка-разворот влево-вправо', price:60, ch:'↪️', cat:'symbols'},
  {id:1372, name:'Стрелка вправо-вверх', price:60, ch:'⤴️', cat:'symbols'},
  {id:1373, name:'Стрелка вправо-вниз', price:60, ch:'⤵️', cat:'symbols'},
  {id:1374, name:'Обновить (по часовой)', price:60, ch:'🔃', cat:'symbols'},
  {id:1375, name:'Обновить (против часовой)', price:60, ch:'🔄', cat:'symbols'},
  {id:1376, name:'Кнопка «Назад»', price:60, ch:'🔙', cat:'symbols'},
  {id:1377, name:'Кнопка «Конец»', price:60, ch:'🔚', cat:'symbols'},
  {id:1378, name:'Кнопка «Вкл»', price:60, ch:'🔛', cat:'symbols'},
  {id:1379, name:'Кнопка «Скоро»', price:60, ch:'🔜', cat:'symbols'},
  {id:1380, name:'Кнопка «Наверх»', price:60, ch:'🔝', cat:'symbols'},
  {id:1381, name:'Место поклонения', price:80, ch:'🛐', cat:'symbols'},
  {id:1382, name:'Символ атома', price:80, ch:'⚛️', cat:'symbols'},
  {id:1383, name:'Ом', price:80, ch:'🕉️', cat:'symbols'},
  {id:1384, name:'Звезда Давида', price:80, ch:'✡️', cat:'symbols'},
  {id:1385, name:'Колесо дхармы', price:80, ch:'☸️', cat:'symbols'},
  {id:1386, name:'Инь-ян', price:80, ch:'☯️', cat:'symbols'},
  {id:1387, name:'Латинский крест', price:80, ch:'✝️', cat:'symbols'},
  {id:1388, name:'Православный крест', price:80, ch:'☦️', cat:'symbols'},
  {id:1389, name:'Звезда и полумесяц', price:80, ch:'☪️', cat:'symbols'},
  {id:1390, name:'Символ мира', price:80, ch:'☮️', cat:'symbols'},
  {id:1391, name:'Менора', price:80, ch:'🕎', cat:'symbols'},
  {id:1392, name:'Пунктирная шестиконечная звезда', price:80, ch:'🔯', cat:'symbols'},
  {id:1393, name:'Кханда', price:80, ch:'🪯', cat:'symbols'},
  {id:1394, name:'Овен', price:80, ch:'♈', cat:'zodiac'},
  {id:1395, name:'Телец', price:80, ch:'♉', cat:'zodiac'},
  {id:1396, name:'Близнецы', price:80, ch:'♊', cat:'zodiac'},
  {id:1397, name:'Рак', price:80, ch:'♋', cat:'zodiac'},
  {id:1398, name:'Лев', price:80, ch:'♌', cat:'zodiac'},
  {id:1399, name:'Дева', price:80, ch:'♍', cat:'zodiac'},
  {id:1400, name:'Весы', price:80, ch:'♎', cat:'zodiac'},
  {id:1401, name:'Скорпион', price:80, ch:'♏', cat:'zodiac'},
  {id:1402, name:'Стрелец', price:80, ch:'♐', cat:'zodiac'},
  {id:1403, name:'Козерог', price:80, ch:'♑', cat:'zodiac'},
  {id:1404, name:'Водолей', price:80, ch:'♒', cat:'zodiac'},
  {id:1405, name:'Рыбы', price:80, ch:'♓', cat:'zodiac'},
  {id:1406, name:'Змееносец', price:80, ch:'⛎', cat:'zodiac'},
  {id:1407, name:'Перемешать', price:60, ch:'🔀', cat:'symbols'},
  {id:1408, name:'Повтор', price:60, ch:'🔁', cat:'symbols'},
  {id:1409, name:'Повтор одного', price:60, ch:'🔂', cat:'symbols'},
  {id:1410, name:'Play', price:60, ch:'▶️', cat:'symbols'},
  {id:1411, name:'Перемотка вперёд', price:60, ch:'⏩', cat:'symbols'},
  {id:1412, name:'Следующий трек', price:60, ch:'⏭️', cat:'symbols'},
  {id:1413, name:'Play/Пауза', price:60, ch:'⏯️', cat:'symbols'},
  {id:1414, name:'Reverse', price:60, ch:'◀️', cat:'symbols'},
  {id:1415, name:'Перемотка назад', price:60, ch:'⏪', cat:'symbols'},
  {id:1416, name:'Предыдущий трек', price:60, ch:'⏮️', cat:'symbols'},
  {id:1417, name:'Кнопка вверх', price:60, ch:'🔼', cat:'symbols'},
  {id:1418, name:'Быстро вверх', price:60, ch:'⏫', cat:'symbols'},
  {id:1419, name:'Кнопка вниз', price:60, ch:'🔽', cat:'symbols'},
  {id:1420, name:'Быстро вниз', price:60, ch:'⏬', cat:'symbols'},
  {id:1421, name:'Пауза', price:60, ch:'⏸️', cat:'symbols'},
  {id:1422, name:'Стоп', price:60, ch:'⏹️', cat:'symbols'},
  {id:1423, name:'Запись', price:60, ch:'⏺️', cat:'symbols'},
  {id:1424, name:'Извлечь', price:60, ch:'⏏️', cat:'symbols'},
  {id:1425, name:'Кинотеатр', price:60, ch:'🎦', cat:'symbols'},
  {id:1426, name:'Тусклее', price:60, ch:'🔅', cat:'symbols'},
  {id:1427, name:'Ярче', price:60, ch:'🔆', cat:'symbols'},
  {id:1428, name:'Антенна', price:60, ch:'📶', cat:'symbols'},
  {id:1429, name:'Wi-Fi', price:60, ch:'🛜', cat:'symbols'},
  {id:1430, name:'Режим вибрации', price:60, ch:'📳', cat:'symbols'},
  {id:1431, name:'Телефон выключен', price:60, ch:'📴', cat:'symbols'},
  {id:1432, name:'Женский знак', price:60, ch:'♀️', cat:'symbols'},
  {id:1433, name:'Мужской знак', price:60, ch:'♂️', cat:'symbols'},
  {id:1434, name:'Трансгендерный символ', price:60, ch:'⚧️', cat:'symbols'},
  {id:1435, name:'Умножить', price:60, ch:'✖️', cat:'symbols'},
  {id:1436, name:'Плюс', price:60, ch:'➕', cat:'symbols'},
  {id:1437, name:'Минус', price:60, ch:'➖', cat:'symbols'},
  {id:1438, name:'Разделить', price:60, ch:'➗', cat:'symbols'},
  {id:1439, name:'Равно', price:60, ch:'🟰', cat:'symbols'},
  {id:1440, name:'Бесконечность', price:60, ch:'♾️', cat:'symbols'},
  {id:1441, name:'Двойной восклицательный', price:60, ch:'‼️', cat:'symbols'},
  {id:1442, name:'Восклицательный вопрос', price:60, ch:'⁉️', cat:'symbols'},
  {id:1443, name:'Красный вопрос', price:60, ch:'❓', cat:'symbols'},
  {id:1444, name:'Белый вопрос', price:60, ch:'❔', cat:'symbols'},
  {id:1445, name:'Белый восклицательный', price:60, ch:'❕', cat:'symbols'},
  {id:1446, name:'Красный восклицательный', price:60, ch:'❗', cat:'symbols'},
  {id:1447, name:'Волнистое тире', price:60, ch:'〰️', cat:'symbols'},
  {id:1448, name:'Обмен валют', price:60, ch:'💱', cat:'symbols'},
  {id:1449, name:'Знак доллара', price:60, ch:'💲', cat:'symbols'},
  {id:1450, name:'Медицинский символ', price:60, ch:'⚕️', cat:'symbols'},
  {id:1451, name:'Переработка', price:60, ch:'♻️', cat:'symbols'},
  {id:1452, name:'Бейджик', price:60, ch:'📛', cat:'symbols'},
  {id:1453, name:'Значок «новичок»', price:60, ch:'🔰', cat:'symbols'},
  {id:1454, name:'Полый красный круг', price:60, ch:'⭕', cat:'symbols'},
  {id:1455, name:'Галочка (кнопка)', price:60, ch:'✅', cat:'symbols'},
  {id:1456, name:'Отмеченный чекбокс', price:60, ch:'☑️', cat:'symbols'},
  {id:1457, name:'Галочка', price:60, ch:'✔️', cat:'symbols'},
  {id:1458, name:'Крестик', price:60, ch:'❌', cat:'symbols'},
  {id:1459, name:'Крестик (кнопка)', price:60, ch:'❎', cat:'symbols'},
  {id:1460, name:'Завиток', price:60, ch:'➰', cat:'symbols'},
  {id:1461, name:'Двойной завиток', price:60, ch:'➿', cat:'symbols'},
  {id:1462, name:'Знак чередования части', price:60, ch:'〽️', cat:'symbols'},
  {id:1463, name:'Восьмилучевая звёздочка', price:60, ch:'✳️', cat:'symbols'},
  {id:1464, name:'Восьмиконечная звезда', price:60, ch:'✴️', cat:'symbols'},
  {id:1465, name:'Искорка', price:60, ch:'❇️', cat:'symbols'},
  {id:1466, name:'Клякса', price:60, ch:'🫟', cat:'symbols'},
  {id:1467, name:'Клавиша #', price:60, ch:'#️⃣', cat:'symbols'},
  {id:1468, name:'Клавиша *', price:60, ch:'*️⃣', cat:'symbols'},
  {id:1469, name:'Клавиша 0', price:60, ch:'0️⃣', cat:'symbols'},
  {id:1470, name:'Клавиша 1', price:60, ch:'1️⃣', cat:'symbols'},
  {id:1471, name:'Клавиша 2', price:60, ch:'2️⃣', cat:'symbols'},
  {id:1472, name:'Клавиша 3', price:60, ch:'3️⃣', cat:'symbols'},
  {id:1473, name:'Клавиша 4', price:60, ch:'4️⃣', cat:'symbols'},
  {id:1474, name:'Клавиша 5', price:60, ch:'5️⃣', cat:'symbols'},
  {id:1475, name:'Клавиша 6', price:60, ch:'6️⃣', cat:'symbols'},
  {id:1476, name:'Клавиша 7', price:60, ch:'7️⃣', cat:'symbols'},
  {id:1477, name:'Клавиша 8', price:60, ch:'8️⃣', cat:'symbols'},
  {id:1478, name:'Клавиша 9', price:60, ch:'9️⃣', cat:'symbols'},
  {id:1479, name:'Клавиша 10', price:60, ch:'🔟', cat:'symbols'},
  {id:1480, name:'Заглавные буквы', price:60, ch:'🔠', cat:'symbols'},
  {id:1481, name:'Строчные буквы', price:60, ch:'🔡', cat:'symbols'},
  {id:1482, name:'Цифры', price:60, ch:'🔢', cat:'symbols'},
  {id:1483, name:'Символы', price:60, ch:'🔣', cat:'symbols'},
  {id:1484, name:'Латинские буквы', price:60, ch:'🔤', cat:'symbols'},
  {id:1485, name:'Кнопка A', price:60, ch:'🅰️', cat:'symbols'},
  {id:1486, name:'Кнопка AB', price:60, ch:'🆎', cat:'symbols'},
  {id:1487, name:'Кнопка B', price:60, ch:'🅱️', cat:'symbols'},
  {id:1488, name:'Кнопка CL', price:60, ch:'🆑', cat:'symbols'},
  {id:1489, name:'Кнопка COOL', price:60, ch:'🆒', cat:'symbols'},
  {id:1490, name:'Кнопка FREE', price:60, ch:'🆓', cat:'symbols'},
  {id:1491, name:'Информация', price:60, ch:'ℹ️', cat:'symbols'},
  {id:1492, name:'Кнопка ID', price:60, ch:'🆔', cat:'symbols'},
  {id:1493, name:'M в круге', price:60, ch:'Ⓜ️', cat:'symbols'},
  {id:1494, name:'Кнопка NEW', price:60, ch:'🆕', cat:'symbols'},
  {id:1495, name:'Кнопка NG', price:60, ch:'🆖', cat:'symbols'},
  {id:1496, name:'Кнопка O', price:60, ch:'🅾️', cat:'symbols'},
  {id:1497, name:'Кнопка OK', price:60, ch:'🆗', cat:'symbols'},
  {id:1498, name:'Кнопка P', price:60, ch:'🅿️', cat:'symbols'},
  {id:1499, name:'Кнопка SOS', price:60, ch:'🆘', cat:'symbols'},
  {id:1500, name:'Кнопка UP!', price:60, ch:'🆙', cat:'symbols'},
  {id:1501, name:'Кнопка VS', price:60, ch:'🆚', cat:'symbols'},
  {id:1502, name:'Японский знак «здесь»', price:60, ch:'🈁', cat:'symbols'},
  {id:1503, name:'Японский знак «плата за обслуживание»', price:60, ch:'🈂️', cat:'symbols'},
  {id:1504, name:'Японский знак «ежемесячная сумма»', price:60, ch:'🈷️', cat:'symbols'},
  {id:1505, name:'Японский знак «платно»', price:60, ch:'🈶', cat:'symbols'},
  {id:1506, name:'Японский знак «занято»', price:60, ch:'🈯', cat:'symbols'},
  {id:1507, name:'Японский знак «выгодно»', price:60, ch:'🉐', cat:'symbols'},
  {id:1508, name:'Японский знак «скидка»', price:60, ch:'🈹', cat:'symbols'},
  {id:1509, name:'Японский знак «бесплатно»', price:60, ch:'🈚', cat:'symbols'},
  {id:1510, name:'Японский знак «запрещено»', price:60, ch:'🈲', cat:'symbols'},
  {id:1511, name:'Японский знак «приемлемо»', price:60, ch:'🉑', cat:'symbols'},
  {id:1512, name:'Японский знак «заявка»', price:60, ch:'🈸', cat:'symbols'},
  {id:1513, name:'Японский знак «сдано»', price:60, ch:'🈴', cat:'symbols'},
  {id:1514, name:'Японский знак «есть места»', price:60, ch:'🈳', cat:'symbols'},
  {id:1515, name:'Японский знак «поздравления»', price:60, ch:'㊗️', cat:'symbols'},
  {id:1516, name:'Японский знак «секрет»', price:60, ch:'㊙️', cat:'symbols'},
  {id:1517, name:'Японский знак «открыто»', price:60, ch:'🈺', cat:'symbols'},
  {id:1518, name:'Японский знак «мест нет»', price:60, ch:'🈵', cat:'symbols'},
  {id:1519, name:'Красный круг', price:60, ch:'🔴', cat:'symbols'},
  {id:1520, name:'Оранжевый круг', price:60, ch:'🟠', cat:'symbols'},
  {id:1521, name:'Жёлтый круг', price:60, ch:'🟡', cat:'symbols'},
  {id:1522, name:'Зелёный круг', price:60, ch:'🟢', cat:'symbols'},
  {id:1523, name:'Синий круг', price:60, ch:'🔵', cat:'symbols'},
  {id:1524, name:'Фиолетовый круг', price:60, ch:'🟣', cat:'symbols'},
  {id:1525, name:'Коричневый круг', price:60, ch:'🟤', cat:'symbols'},
  {id:1526, name:'Чёрный круг', price:60, ch:'⚫', cat:'symbols'},
  {id:1527, name:'Белый круг', price:60, ch:'⚪', cat:'symbols'},
  {id:1528, name:'Красный квадрат', price:60, ch:'🟥', cat:'symbols'},
  {id:1529, name:'Оранжевый квадрат', price:60, ch:'🟧', cat:'symbols'},
  {id:1530, name:'Жёлтый квадрат', price:60, ch:'🟨', cat:'symbols'},
  {id:1531, name:'Зелёный квадрат', price:60, ch:'🟩', cat:'symbols'},
  {id:1532, name:'Синий квадрат', price:60, ch:'🟦', cat:'symbols'},
  {id:1533, name:'Фиолетовый квадрат', price:60, ch:'🟪', cat:'symbols'},
  {id:1534, name:'Коричневый квадрат', price:60, ch:'🟫', cat:'symbols'},
  {id:1535, name:'Большой чёрный квадрат', price:60, ch:'⬛', cat:'symbols'},
  {id:1536, name:'Большой белый квадрат', price:60, ch:'⬜', cat:'symbols'},
  {id:1537, name:'Средний чёрный квадрат', price:60, ch:'◼️', cat:'symbols'},
  {id:1538, name:'Средний белый квадрат', price:60, ch:'◻️', cat:'symbols'},
  {id:1539, name:'Средне-малый чёрный квадрат', price:60, ch:'◾', cat:'symbols'},
  {id:1540, name:'Средне-малый белый квадрат', price:60, ch:'◽', cat:'symbols'},
  {id:1541, name:'Малый чёрный квадрат', price:60, ch:'▪️', cat:'symbols'},
  {id:1542, name:'Малый белый квадрат', price:60, ch:'▫️', cat:'symbols'},
  {id:1543, name:'Большой оранжевый ромб', price:60, ch:'🔶', cat:'symbols'},
  {id:1544, name:'Большой синий ромб', price:60, ch:'🔷', cat:'symbols'},
  {id:1545, name:'Малый оранжевый ромб', price:60, ch:'🔸', cat:'symbols'},
  {id:1546, name:'Малый синий ромб', price:60, ch:'🔹', cat:'symbols'},
  {id:1547, name:'Красный треугольник вверх', price:60, ch:'🔺', cat:'symbols'},
  {id:1548, name:'Красный треугольник вниз', price:60, ch:'🔻', cat:'symbols'},
  {id:1549, name:'Ромб с точкой', price:60, ch:'💠', cat:'symbols'},
  {id:1550, name:'Радиокнопка', price:60, ch:'🔘', cat:'symbols'},
  {id:1551, name:'Белая кнопка-квадрат', price:60, ch:'🔳', cat:'symbols'},
  {id:1552, name:'Чёрная кнопка-квадрат', price:60, ch:'🔲', cat:'symbols'},
  {id:1553, name:'Машущая рука', price:80, ch:'👋', cat:'hands'},
  {id:1554, name:'Поднятая тыльная сторона ладони', price:80, ch:'🤚', cat:'hands'},
  {id:1555, name:'Ладонь с растопыренными пальцами', price:80, ch:'🖐️', cat:'hands'},
  {id:1556, name:'Поднятая ладонь', price:80, ch:'✋', cat:'hands'},
  {id:1557, name:'Вулканский салют', price:80, ch:'🖖', cat:'hands'},
  {id:1558, name:'Ладонь вправо', price:80, ch:'🫱', cat:'hands'},
  {id:1559, name:'Ладонь влево', price:80, ch:'🫲', cat:'hands'},
  {id:1560, name:'Ладонь вниз', price:80, ch:'🫳', cat:'hands'},
  {id:1561, name:'Ладонь вверх', price:80, ch:'🫴', cat:'hands'},
  {id:1562, name:'Толчок влево ладонью', price:80, ch:'🫷', cat:'hands'},
  {id:1563, name:'Толчок вправо ладонью', price:80, ch:'🫸', cat:'hands'},
  {id:1564, name:'Жест ОК', price:80, ch:'👌', cat:'hands'},
  {id:1565, name:'Щепотка пальцев', price:80, ch:'🤌', cat:'hands'},
  {id:1566, name:'Щипающая рука', price:80, ch:'🤏', cat:'hands'},
  {id:1567, name:'Знак победы', price:80, ch:'✌️', cat:'hands'},
  {id:1568, name:'Скрещённые пальцы', price:80, ch:'🤞', cat:'hands'},
  {id:1569, name:'Сердечко пальцами', price:80, ch:'🫰', cat:'hands'},
  {id:1570, name:'Жест «Люблю тебя»', price:80, ch:'🤟', cat:'hands'},
  {id:1571, name:'Жест «Рога»', price:80, ch:'🤘', cat:'hands'},
  {id:1572, name:'Жест «Позвони мне»', price:80, ch:'🤙', cat:'hands'},
  {id:1573, name:'Указывает влево', price:80, ch:'👈', cat:'hands'},
  {id:1574, name:'Указывает вправо', price:80, ch:'👉', cat:'hands'},
  {id:1575, name:'Указывает вверх', price:80, ch:'👆', cat:'hands'},
  {id:1576, name:'Указывает вниз', price:80, ch:'👇', cat:'hands'},
  {id:1577, name:'Палец вверх', price:80, ch:'☝️', cat:'hands'},
  {id:1578, name:'Палец на зрителя', price:80, ch:'🫵', cat:'hands'},
  {id:1579, name:'Класс', price:80, ch:'👍', cat:'hands'},
  {id:1580, name:'Не класс', price:80, ch:'👎', cat:'hands'},
  {id:1581, name:'Поднятый кулак', price:80, ch:'✊', cat:'hands'},
  {id:1582, name:'Кулак навстречу', price:80, ch:'👊', cat:'hands'},
  {id:1583, name:'Кулак влево', price:80, ch:'🤛', cat:'hands'},
  {id:1584, name:'Кулак вправо', price:80, ch:'🤜', cat:'hands'},
  {id:1585, name:'Аплодисменты', price:80, ch:'👏', cat:'hands'},
  {id:1586, name:'Руки вверх', price:80, ch:'🙌', cat:'hands'},
  {id:1587, name:'Сердце из ладоней', price:80, ch:'🫶', cat:'hands'},
  {id:1588, name:'Открытые ладони', price:80, ch:'👐', cat:'hands'},
  {id:1589, name:'Сложенные ладони', price:80, ch:'🤲', cat:'hands'},
  {id:1590, name:'Рукопожатие', price:80, ch:'🤝', cat:'hands'},
  {id:1591, name:'Молитвенно сложенные руки', price:80, ch:'🙏', cat:'hands'},
  {id:1592, name:'Пишущая рука', price:80, ch:'✍️', cat:'hands'},
  {id:1593, name:'Лак для ногтей', price:80, ch:'💅', cat:'hands'},
  {id:1594, name:'Селфи', price:80, ch:'🤳', cat:'hands'},
  {id:1595, name:'Накачанная рука', price:80, ch:'💪', cat:'body'},
  {id:1596, name:'Механическая рука', price:80, ch:'🦾', cat:'body'},
  {id:1597, name:'Механическая нога', price:80, ch:'🦿', cat:'body'},
  {id:1598, name:'Нога', price:80, ch:'🦵', cat:'body'},
  {id:1599, name:'Стопа', price:80, ch:'🦶', cat:'body'},
  {id:1600, name:'Ухо', price:80, ch:'👂', cat:'body'},
  {id:1601, name:'Ухо со слуховым аппаратом', price:80, ch:'🦻', cat:'body'},
  {id:1602, name:'Нос', price:80, ch:'👃', cat:'body'},
  {id:1603, name:'Мозг', price:80, ch:'🧠', cat:'body'},
  {id:1604, name:'Анатомическое сердце', price:80, ch:'🫀', cat:'body'},
  {id:1605, name:'Лёгкие', price:80, ch:'🫁', cat:'body'},
  {id:1606, name:'Зуб', price:80, ch:'🦷', cat:'body'},
  {id:1607, name:'Кость', price:80, ch:'🦴', cat:'body'},
  {id:1608, name:'Глаза', price:80, ch:'👀', cat:'body'},
  {id:1609, name:'Глаз', price:80, ch:'👁️', cat:'body'},
  {id:1610, name:'Язык', price:80, ch:'👅', cat:'body'},
  {id:1611, name:'Рот', price:80, ch:'👄', cat:'body'},
  {id:1612, name:'Закушенная губа', price:80, ch:'🫦', cat:'body'},
  {id:1613, name:'Малыш', price:80, ch:'👶', cat:'person'},
  {id:1614, name:'Ребёнок', price:80, ch:'🧒', cat:'person'},
  {id:1615, name:'Мальчик', price:80, ch:'👦', cat:'person'},
  {id:1616, name:'Девочка', price:80, ch:'👧', cat:'person'},
  {id:1617, name:'Человек', price:80, ch:'🧑', cat:'person'},
  {id:1618, name:'Блондин(ка)', price:80, ch:'👱', cat:'person'},
  {id:1619, name:'Мужчина', price:80, ch:'👨', cat:'person'},
  {id:1620, name:'Человек с бородой', price:80, ch:'🧔', cat:'person'},
  {id:1621, name:'Мужчина с бородой', price:80, ch:'🧔‍♂️', cat:'person'},
  {id:1622, name:'Женщина с бородой', price:80, ch:'🧔‍♀️', cat:'person'},
  {id:1623, name:'Рыжий мужчина', price:80, ch:'👨‍🦰', cat:'person'},
  {id:1624, name:'Кудрявый мужчина', price:80, ch:'👨‍🦱', cat:'person'},
  {id:1625, name:'Седой мужчина', price:80, ch:'👨‍🦳', cat:'person'},
  {id:1626, name:'Лысый мужчина', price:80, ch:'👨‍🦲', cat:'person'},
  {id:1627, name:'Женщина', price:80, ch:'👩', cat:'person'},
  {id:1628, name:'Рыжая женщина', price:80, ch:'👩‍🦰', cat:'person'},
  {id:1629, name:'Рыжий человек', price:80, ch:'🧑‍🦰', cat:'person'},
  {id:1630, name:'Кудрявая женщина', price:80, ch:'👩‍🦱', cat:'person'},
  {id:1631, name:'Кудрявый человек', price:80, ch:'🧑‍🦱', cat:'person'},
  {id:1632, name:'Седая женщина', price:80, ch:'👩‍🦳', cat:'person'},
  {id:1633, name:'Седой человек', price:80, ch:'🧑‍🦳', cat:'person'},
  {id:1634, name:'Лысая женщина', price:80, ch:'👩‍🦲', cat:'person'},
  {id:1635, name:'Лысый человек', price:80, ch:'🧑‍🦲', cat:'person'},
  {id:1636, name:'Блондинка', price:80, ch:'👱‍♀️', cat:'person'},
  {id:1637, name:'Блондин', price:80, ch:'👱‍♂️', cat:'person'},
  {id:1638, name:'Пожилой человек', price:80, ch:'🧓', cat:'person'},
  {id:1639, name:'Старик', price:80, ch:'👴', cat:'person'},
  {id:1640, name:'Старушка', price:80, ch:'👵', cat:'person'},
  {id:1641, name:'Хмурый человек', price:80, ch:'🙍', cat:'person'},
  {id:1642, name:'Хмурый мужчина', price:80, ch:'🙍‍♂️', cat:'person'},
  {id:1643, name:'Хмурая женщина', price:80, ch:'🙍‍♀️', cat:'person'},
  {id:1644, name:'Надутый человек', price:80, ch:'🙎', cat:'person'},
  {id:1645, name:'Надутый мужчина', price:80, ch:'🙎‍♂️', cat:'person'},
  {id:1646, name:'Надутая женщина', price:80, ch:'🙎‍♀️', cat:'person'},
  {id:1647, name:'Жест «нет» (человек)', price:80, ch:'🙅', cat:'person'},
  {id:1648, name:'Жест «нет» (мужчина)', price:80, ch:'🙅‍♂️', cat:'person'},
  {id:1649, name:'Жест «нет» (женщина)', price:80, ch:'🙅‍♀️', cat:'person'},
  {id:1650, name:'Жест «ОК» (человек)', price:80, ch:'🙆', cat:'person'},
  {id:1651, name:'Жест «ОК» (мужчина)', price:80, ch:'🙆‍♂️', cat:'person'},
  {id:1652, name:'Жест «ОК» (женщина)', price:80, ch:'🙆‍♀️', cat:'person'},
  {id:1653, name:'Жест-подсказка (человек)', price:80, ch:'💁', cat:'person'},
  {id:1654, name:'Жест-подсказка (мужчина)', price:80, ch:'💁‍♂️', cat:'person'},
  {id:1655, name:'Жест-подсказка (женщина)', price:80, ch:'💁‍♀️', cat:'person'},
  {id:1656, name:'Поднятая рука (человек)', price:80, ch:'🙋', cat:'person'},
  {id:1657, name:'Поднятая рука (мужчина)', price:80, ch:'🙋‍♂️', cat:'person'},
  {id:1658, name:'Поднятая рука (женщина)', price:80, ch:'🙋‍♀️', cat:'person'},
  {id:1659, name:'Глухой человек', price:80, ch:'🧏', cat:'person'},
  {id:1660, name:'Глухой мужчина', price:80, ch:'🧏‍♂️', cat:'person'},
  {id:1661, name:'Глухая женщина', price:80, ch:'🧏‍♀️', cat:'person'},
  {id:1662, name:'Кланяющийся человек', price:80, ch:'🙇', cat:'person'},
  {id:1663, name:'Кланяющийся мужчина', price:80, ch:'🙇‍♂️', cat:'person'},
  {id:1664, name:'Кланяющаяся женщина', price:80, ch:'🙇‍♀️', cat:'person'},
  {id:1665, name:'Фейспалм (человек)', price:80, ch:'🤦', cat:'person'},
  {id:1666, name:'Фейспалм (мужчина)', price:80, ch:'🤦‍♂️', cat:'person'},
  {id:1667, name:'Фейспалм (женщина)', price:80, ch:'🤦‍♀️', cat:'person'},
  {id:1668, name:'Пожимающий плечами (человек)', price:80, ch:'🤷', cat:'person'},
  {id:1669, name:'Пожимающий плечами (мужчина)', price:80, ch:'🤷‍♂️', cat:'person'},
  {id:1670, name:'Пожимающая плечами (женщина)', price:80, ch:'🤷‍♀️', cat:'person'},
  {id:1671, name:'Медработник', price:80, ch:'🧑‍⚕️', cat:'person'},
  {id:1672, name:'Медработник', price:80, ch:'👨‍⚕️', cat:'person'},
  {id:1673, name:'Медработница', price:80, ch:'👩‍⚕️', cat:'person'},
  {id:1674, name:'Студент', price:80, ch:'🧑‍🎓', cat:'person'},
  {id:1675, name:'Студент', price:80, ch:'👨‍🎓', cat:'person'},
  {id:1676, name:'Студентка', price:80, ch:'👩‍🎓', cat:'person'},
  {id:1677, name:'Учитель', price:80, ch:'🧑‍🏫', cat:'person'},
  {id:1678, name:'Учитель', price:80, ch:'👨‍🏫', cat:'person'},
  {id:1679, name:'Учительница', price:80, ch:'👩‍🏫', cat:'person'},
  {id:1680, name:'Судья', price:80, ch:'🧑‍⚖️', cat:'person'},
  {id:1681, name:'Судья', price:80, ch:'👨‍⚖️', cat:'person'},
  {id:1682, name:'Женщина-судья', price:80, ch:'👩‍⚖️', cat:'person'},
  {id:1683, name:'Фермер', price:80, ch:'🧑‍🌾', cat:'person'},
  {id:1684, name:'Фермер', price:80, ch:'👨‍🌾', cat:'person'},
  {id:1685, name:'Женщина-фермер', price:80, ch:'👩‍🌾', cat:'person'},
  {id:1686, name:'Повар', price:80, ch:'🧑‍🍳', cat:'person'},
  {id:1687, name:'Повар', price:80, ch:'👨‍🍳', cat:'person'},
  {id:1688, name:'Женщина-повар', price:80, ch:'👩‍🍳', cat:'person'},
  {id:1689, name:'Механик', price:80, ch:'🧑‍🔧', cat:'person'},
  {id:1690, name:'Механик', price:80, ch:'👨‍🔧', cat:'person'},
  {id:1691, name:'Женщина-механик', price:80, ch:'👩‍🔧', cat:'person'},
  {id:1692, name:'Рабочий', price:80, ch:'🧑‍🏭', cat:'person'},
  {id:1693, name:'Рабочий', price:80, ch:'👨‍🏭', cat:'person'},
  {id:1694, name:'Работница', price:80, ch:'👩‍🏭', cat:'person'},
  {id:1695, name:'Офисный работник', price:80, ch:'🧑‍💼', cat:'person'},
  {id:1696, name:'Офисный работник', price:80, ch:'👨‍💼', cat:'person'},
  {id:1697, name:'Офисная работница', price:80, ch:'👩‍💼', cat:'person'},
  {id:1698, name:'Учёный', price:80, ch:'🧑‍🔬', cat:'person'},
  {id:1699, name:'Учёный', price:80, ch:'👨‍🔬', cat:'person'},
  {id:1700, name:'Женщина-учёный', price:80, ch:'👩‍🔬', cat:'person'},
  {id:1701, name:'IT-специалист', price:80, ch:'🧑‍💻', cat:'person'},
  {id:1702, name:'IT-специалист', price:80, ch:'👨‍💻', cat:'person'},
  {id:1703, name:'Женщина IT-специалист', price:80, ch:'👩‍💻', cat:'person'},
  {id:1704, name:'Певец', price:80, ch:'🧑‍🎤', cat:'person'},
  {id:1705, name:'Певец', price:80, ch:'👨‍🎤', cat:'person'},
  {id:1706, name:'Певица', price:80, ch:'👩‍🎤', cat:'person'},
  {id:1707, name:'Художник', price:80, ch:'🧑‍🎨', cat:'person'},
  {id:1708, name:'Художник', price:80, ch:'👨‍🎨', cat:'person'},
  {id:1709, name:'Художница', price:80, ch:'👩‍🎨', cat:'person'},
  {id:1710, name:'Пилот', price:80, ch:'🧑‍✈️', cat:'person'},
  {id:1711, name:'Пилот', price:80, ch:'👨‍✈️', cat:'person'},
  {id:1712, name:'Женщина-пилот', price:80, ch:'👩‍✈️', cat:'person'},
  {id:1713, name:'Космонавт', price:350, ch:'🧑‍🚀', cat:'person'},
  {id:1714, name:'Космонавт', price:350, ch:'👨‍🚀', cat:'person'},
  {id:1715, name:'Женщина-космонавт', price:350, ch:'👩‍🚀', cat:'person'},
  {id:1716, name:'Пожарный', price:80, ch:'🧑‍🚒', cat:'person'},
  {id:1717, name:'Пожарный', price:80, ch:'👨‍🚒', cat:'person'},
  {id:1718, name:'Женщина-пожарный', price:80, ch:'👩‍🚒', cat:'person'},
  {id:1719, name:'Полицейский', price:80, ch:'👮', cat:'person'},
  {id:1720, name:'Полицейский', price:80, ch:'👮‍♂️', cat:'person'},
  {id:1721, name:'Женщина-полицейский', price:80, ch:'👮‍♀️', cat:'person'},
  {id:1722, name:'Детектив', price:80, ch:'🕵️', cat:'person'},
  {id:1723, name:'Детектив', price:80, ch:'🕵️‍♂️', cat:'person'},
  {id:1724, name:'Женщина-детектив', price:80, ch:'🕵️‍♀️', cat:'person'},
  {id:1725, name:'Гвардеец', price:80, ch:'💂', cat:'person'},
  {id:1726, name:'Гвардеец', price:80, ch:'💂‍♂️', cat:'person'},
  {id:1727, name:'Женщина-гвардеец', price:80, ch:'💂‍♀️', cat:'person'},
  {id:1728, name:'Строитель', price:80, ch:'👷', cat:'person'},
  {id:1729, name:'Строитель', price:80, ch:'👷‍♂️', cat:'person'},
  {id:1730, name:'Женщина-строитель', price:80, ch:'👷‍♀️', cat:'person'},
  {id:1731, name:'Человек в короне', price:350, ch:'🫅', cat:'person'},
  {id:1732, name:'Принц', price:350, ch:'🤴', cat:'person'},
  {id:1733, name:'Принцесса', price:350, ch:'👸', cat:'person'},
  {id:1734, name:'Человек в тюрбане', price:80, ch:'👳', cat:'person'},
  {id:1735, name:'Мужчина в тюрбане', price:80, ch:'👳‍♂️', cat:'person'},
  {id:1736, name:'Женщина в тюрбане', price:80, ch:'👳‍♀️', cat:'person'},
  {id:1737, name:'Человек в тюбетейке', price:80, ch:'👲', cat:'person'},
  {id:1738, name:'Женщина в платке', price:80, ch:'🧕', cat:'person'},
  {id:1739, name:'Человек в смокинге', price:80, ch:'🤵', cat:'person'},
  {id:1740, name:'Мужчина в смокинге', price:80, ch:'🤵‍♂️', cat:'person'},
  {id:1741, name:'Женщина в смокинге', price:80, ch:'🤵‍♀️', cat:'person'},
  {id:1742, name:'Человек под вуалью', price:80, ch:'👰', cat:'person'},
  {id:1743, name:'Мужчина под вуалью', price:80, ch:'👰‍♂️', cat:'person'},
  {id:1744, name:'Невеста под вуалью', price:80, ch:'👰‍♀️', cat:'person'},
  {id:1745, name:'Беременная женщина', price:80, ch:'🤰', cat:'person'},
  {id:1746, name:'Беременный мужчина', price:80, ch:'🫃', cat:'person'},
  {id:1747, name:'Беременный человек', price:80, ch:'🫄', cat:'person'},
  {id:1748, name:'Кормление грудью', price:80, ch:'🤱', cat:'person'},
  {id:1749, name:'Женщина кормит малыша', price:80, ch:'👩‍🍼', cat:'person'},
  {id:1750, name:'Мужчина кормит малыша', price:80, ch:'👨‍🍼', cat:'person'},
  {id:1751, name:'Человек кормит малыша', price:80, ch:'🧑‍🍼', cat:'person'},
  {id:1752, name:'Ангелочек', price:350, ch:'👼', cat:'myth'},
  {id:1753, name:'Санта-Клаус', price:350, ch:'🎅', cat:'myth'},
  {id:1754, name:'Миссис Клаус', price:350, ch:'🤶', cat:'myth'},
  {id:1755, name:'Клаус', price:350, ch:'🧑‍🎄', cat:'myth'},
  {id:1756, name:'Супергерой', price:350, ch:'🦸', cat:'myth'},
  {id:1757, name:'Суперзлодей', price:350, ch:'🦹', cat:'myth'},
  {id:1758, name:'Маг', price:350, ch:'🧙', cat:'myth'},
  {id:1759, name:'Фея', price:350, ch:'🧚', cat:'myth'},
  {id:1760, name:'Вампир', price:350, ch:'🧛', cat:'myth'},
  {id:1761, name:'Тритон', price:350, ch:'🧜‍♂️', cat:'myth'},
  {id:1762, name:'Русалка', price:350, ch:'🧜‍♀️', cat:'myth'},
  {id:1763, name:'Эльф', price:350, ch:'🧝', cat:'myth'},
  {id:1764, name:'Эльф', price:350, ch:'🧝‍♂️', cat:'myth'},
  {id:1765, name:'Эльфийка', price:350, ch:'🧝‍♀️', cat:'myth'},
  {id:1766, name:'Джинн', price:350, ch:'🧞‍♂️', cat:'myth'},
  {id:1767, name:'Джинн-женщина', price:350, ch:'🧞‍♀️', cat:'myth'},
  {id:1768, name:'Зомби', price:350, ch:'🧟‍♂️', cat:'myth'},
  {id:1769, name:'Зомби-женщина', price:350, ch:'🧟‍♀️', cat:'myth'},
  {id:1770, name:'Тролль', price:350, ch:'🧌', cat:'myth'},
  {id:1771, name:'Волосатое существо', price:350, ch:'🫈', cat:'myth'},
  {id:1772, name:'Массаж', price:80, ch:'💆', cat:'person'},
  {id:1773, name:'Массаж (мужчина)', price:80, ch:'💆‍♂️', cat:'person'},
  {id:1774, name:'Массаж (женщина)', price:80, ch:'💆‍♀️', cat:'person'},
  {id:1775, name:'Стрижка', price:80, ch:'💇', cat:'person'},
  {id:1776, name:'Стрижка (мужчина)', price:80, ch:'💇‍♂️', cat:'person'},
  {id:1777, name:'Стрижка (женщина)', price:80, ch:'💇‍♀️', cat:'person'},
  {id:1778, name:'Идущий человек', price:80, ch:'🚶', cat:'person'},
  {id:1779, name:'Идущий мужчина', price:80, ch:'🚶‍♂️', cat:'person'},
  {id:1780, name:'Идущая женщина', price:80, ch:'🚶‍♀️', cat:'person'},
  {id:1781, name:'Идёт вправо', price:80, ch:'🚶‍➡️', cat:'person'},
  {id:1782, name:'Идёт вправо (женщина)', price:80, ch:'🚶‍♀️‍➡️', cat:'person'},
  {id:1783, name:'Идёт вправо (мужчина)', price:80, ch:'🚶‍♂️‍➡️', cat:'person'},
  {id:1784, name:'Стоящий человек', price:80, ch:'🧍', cat:'person'},
  {id:1785, name:'Стоящий мужчина', price:80, ch:'🧍‍♂️', cat:'person'},
  {id:1786, name:'Стоящая женщина', price:80, ch:'🧍‍♀️', cat:'person'},
  {id:1787, name:'На коленях', price:80, ch:'🧎', cat:'person'},
  {id:1788, name:'На коленях (мужчина)', price:80, ch:'🧎‍♂️', cat:'person'},
  {id:1789, name:'На коленях (женщина)', price:80, ch:'🧎‍♀️', cat:'person'},
  {id:1790, name:'На коленях, вправо', price:80, ch:'🧎‍➡️', cat:'person'},
  {id:1791, name:'На коленях, вправо (женщина)', price:80, ch:'🧎‍♀️‍➡️', cat:'person'},
  {id:1792, name:'На коленях, вправо (мужчина)', price:80, ch:'🧎‍♂️‍➡️', cat:'person'},
  {id:1793, name:'С белой тростью', price:80, ch:'🧑‍🦯', cat:'person'},
  {id:1794, name:'С белой тростью, вправо', price:80, ch:'🧑‍🦯‍➡️', cat:'person'},
  {id:1795, name:'С белой тростью (мужчина)', price:80, ch:'👨‍🦯', cat:'person'},
  {id:1796, name:'С белой тростью, вправо (мужчина)', price:80, ch:'👨‍🦯‍➡️', cat:'person'},
  {id:1797, name:'С белой тростью (женщина)', price:80, ch:'👩‍🦯', cat:'person'},
  {id:1798, name:'С белой тростью, вправо (женщина)', price:80, ch:'👩‍🦯‍➡️', cat:'person'},
  {id:1799, name:'В электроколяске', price:80, ch:'🧑‍🦼', cat:'person'},
  {id:1800, name:'В электроколяске, вправо', price:80, ch:'🧑‍🦼‍➡️', cat:'person'},
  {id:1801, name:'В электроколяске (мужчина)', price:80, ch:'👨‍🦼', cat:'person'},
  {id:1802, name:'В электроколяске, вправо (мужчина)', price:80, ch:'👨‍🦼‍➡️', cat:'person'},
  {id:1803, name:'В электроколяске (женщина)', price:80, ch:'👩‍🦼', cat:'person'},
  {id:1804, name:'В электроколяске, вправо (женщина)', price:80, ch:'👩‍🦼‍➡️', cat:'person'},
  {id:1805, name:'В инвалидной коляске', price:80, ch:'🧑‍🦽', cat:'person'},
  {id:1806, name:'В инвалидной коляске, вправо', price:80, ch:'🧑‍🦽‍➡️', cat:'person'},
  {id:1807, name:'В инвалидной коляске (мужчина)', price:80, ch:'👨‍🦽', cat:'person'},
  {id:1808, name:'В инвалидной коляске, вправо (мужчина)', price:80, ch:'👨‍🦽‍➡️', cat:'person'},
  {id:1809, name:'В инвалидной коляске (женщина)', price:80, ch:'👩‍🦽', cat:'person'},
  {id:1810, name:'В инвалидной коляске, вправо (женщина)', price:80, ch:'👩‍🦽‍➡️', cat:'person'},
  {id:1811, name:'Бегущий человек', price:80, ch:'🏃', cat:'person'},
  {id:1812, name:'Бегущий мужчина', price:80, ch:'🏃‍♂️', cat:'person'},
  {id:1813, name:'Бегущая женщина', price:80, ch:'🏃‍♀️', cat:'person'},
  {id:1814, name:'Бежит вправо', price:80, ch:'🏃‍➡️', cat:'person'},
  {id:1815, name:'Бежит вправо (женщина)', price:80, ch:'🏃‍♀️‍➡️', cat:'person'},
  {id:1816, name:'Бежит вправо (мужчина)', price:80, ch:'🏃‍♂️‍➡️', cat:'person'},
  {id:1817, name:'Артист балета', price:80, ch:'🧑‍🩰', cat:'person'},
  {id:1818, name:'Танцующая женщина', price:80, ch:'💃', cat:'person'},
  {id:1819, name:'Танцующий мужчина', price:80, ch:'🕺', cat:'person'},
  {id:1820, name:'Левитирующий в костюме', price:80, ch:'🕴️', cat:'person'},
  {id:1821, name:'Люди с ушками зайца', price:80, ch:'👯', cat:'person'},
  {id:1822, name:'Мужчины с ушками зайца', price:80, ch:'👯‍♂️', cat:'person'},
  {id:1823, name:'Женщины с ушками зайца', price:80, ch:'👯‍♀️', cat:'person'},
  {id:1824, name:'В парной', price:80, ch:'🧖', cat:'person'},
  {id:1825, name:'В парной (мужчина)', price:80, ch:'🧖‍♂️', cat:'person'},
  {id:1826, name:'В парной (женщина)', price:80, ch:'🧖‍♀️', cat:'person'},
  {id:1827, name:'Скалолаз', price:80, ch:'🧗', cat:'person'},
  {id:1828, name:'Скалолаз (мужчина)', price:80, ch:'🧗‍♂️', cat:'person'},
  {id:1829, name:'Скалолазка', price:80, ch:'🧗‍♀️', cat:'person'},
  {id:1830, name:'Фехтовальщик', price:80, ch:'🤺', cat:'person'},
  {id:1831, name:'Скачки', price:80, ch:'🏇', cat:'person'},
  {id:1832, name:'Лыжник', price:80, ch:'⛷️', cat:'person'},
  {id:1833, name:'Сноубордист', price:80, ch:'🏂', cat:'person'},
  {id:1834, name:'Гольфист', price:80, ch:'🏌️', cat:'person'},
  {id:1835, name:'Гольфист', price:80, ch:'🏌️‍♂️', cat:'person'},
  {id:1836, name:'Гольфистка', price:80, ch:'🏌️‍♀️', cat:'person'},
  {id:1837, name:'Сёрфингист', price:80, ch:'🏄', cat:'person'},
  {id:1838, name:'Сёрфингист', price:80, ch:'🏄‍♂️', cat:'person'},
  {id:1839, name:'Сёрфингистка', price:80, ch:'🏄‍♀️', cat:'person'},
  {id:1840, name:'Гребец', price:80, ch:'🚣', cat:'person'},
  {id:1841, name:'Гребец', price:80, ch:'🚣‍♂️', cat:'person'},
  {id:1842, name:'Женщина-гребец', price:80, ch:'🚣‍♀️', cat:'person'},
  {id:1843, name:'Пловец', price:80, ch:'🏊', cat:'person'},
  {id:1844, name:'Пловец', price:80, ch:'🏊‍♂️', cat:'person'},
  {id:1845, name:'Пловчиха', price:80, ch:'🏊‍♀️', cat:'person'},
  {id:1846, name:'Игрок с мячом', price:80, ch:'⛹️', cat:'person'},
  {id:1847, name:'Игрок с мячом', price:80, ch:'⛹️‍♂️', cat:'person'},
  {id:1848, name:'Женщина с мячом', price:80, ch:'⛹️‍♀️', cat:'person'},
  {id:1849, name:'Тяжелоатлет', price:80, ch:'🏋️', cat:'person'},
  {id:1850, name:'Тяжелоатлет', price:80, ch:'🏋️‍♂️', cat:'person'},
  {id:1851, name:'Тяжелоатлетка', price:80, ch:'🏋️‍♀️', cat:'person'},
  {id:1852, name:'Велосипедист', price:80, ch:'🚴', cat:'person'},
  {id:1853, name:'Велосипедист', price:80, ch:'🚴‍♂️', cat:'person'},
  {id:1854, name:'Велосипедистка', price:80, ch:'🚴‍♀️', cat:'person'},
  {id:1855, name:'Маунтинбайкер', price:80, ch:'🚵', cat:'person'},
  {id:1856, name:'Маунтинбайкер', price:80, ch:'🚵‍♂️', cat:'person'},
  {id:1857, name:'Женщина-маунтинбайкер', price:80, ch:'🚵‍♀️', cat:'person'},
  {id:1858, name:'Колесо (гимнастика)', price:80, ch:'🤸', cat:'person'},
  {id:1859, name:'Колесо (мужчина)', price:80, ch:'🤸‍♂️', cat:'person'},
  {id:1860, name:'Колесо (женщина)', price:80, ch:'🤸‍♀️', cat:'person'},
  {id:1861, name:'Борцы', price:80, ch:'🤼', cat:'person'},
  {id:1862, name:'Борцы (мужчины)', price:80, ch:'🤼‍♂️', cat:'person'},
  {id:1863, name:'Борцы (женщины)', price:80, ch:'🤼‍♀️', cat:'person'},
  {id:1864, name:'Ватерполист', price:80, ch:'🤽', cat:'person'},
  {id:1865, name:'Ватерполист', price:80, ch:'🤽‍♂️', cat:'person'},
  {id:1866, name:'Ватерполистка', price:80, ch:'🤽‍♀️', cat:'person'},
  {id:1867, name:'Гандболист', price:80, ch:'🤾', cat:'person'},
  {id:1868, name:'Гандболист', price:80, ch:'🤾‍♂️', cat:'person'},
  {id:1869, name:'Гандболистка', price:80, ch:'🤾‍♀️', cat:'person'},
  {id:1870, name:'Жонглёр', price:80, ch:'🤹', cat:'person'},
  {id:1871, name:'Жонглёр', price:80, ch:'🤹‍♂️', cat:'person'},
  {id:1872, name:'Женщина-жонглёр', price:80, ch:'🤹‍♀️', cat:'person'},
  {id:1873, name:'Медитация', price:80, ch:'🧘', cat:'person'},
  {id:1874, name:'Медитация (мужчина)', price:80, ch:'🧘‍♂️', cat:'person'},
  {id:1875, name:'Медитация (женщина)', price:80, ch:'🧘‍♀️', cat:'person'},
  {id:1876, name:'Принимает ванну', price:80, ch:'🛀', cat:'person'},
  {id:1877, name:'В постели', price:80, ch:'🛌', cat:'person'},
  {id:1878, name:'Держатся за руки', price:80, ch:'🧑‍🤝‍🧑', cat:'family'},
  {id:1879, name:'Женщины держатся за руки', price:80, ch:'👭', cat:'family'},
  {id:1880, name:'Мужчина и женщина за руки', price:80, ch:'👫', cat:'family'},
  {id:1881, name:'Мужчины держатся за руки', price:80, ch:'👬', cat:'family'},
  {id:1882, name:'Поцелуй', price:80, ch:'💏', cat:'family'},
  {id:1883, name:'Поцелуй (женщина и мужчина)', price:80, ch:'👩‍❤️‍💋‍👨', cat:'family'},
  {id:1884, name:'Поцелуй (двое мужчин)', price:80, ch:'👨‍❤️‍💋‍👨', cat:'family'},
  {id:1885, name:'Поцелуй (две женщины)', price:80, ch:'👩‍❤️‍💋‍👩', cat:'family'},
  {id:1886, name:'Пара с сердцем', price:80, ch:'💑', cat:'family'},
  {id:1887, name:'Пара с сердцем (женщина и мужчина)', price:80, ch:'👩‍❤️‍👨', cat:'family'},
  {id:1888, name:'Пара с сердцем (двое мужчин)', price:80, ch:'👨‍❤️‍👨', cat:'family'},
  {id:1889, name:'Пара с сердцем (две женщины)', price:80, ch:'👩‍❤️‍👩', cat:'family'},
  {id:1890, name:'Семья: папа, мама, сын', price:80, ch:'👨‍👩‍👦', cat:'family'},
  {id:1891, name:'Семья: папа, мама, дочь', price:80, ch:'👨‍👩‍👧', cat:'family'},
  {id:1892, name:'Семья: папа, мама, дочь и сын', price:80, ch:'👨‍👩‍👧‍👦', cat:'family'},
  {id:1893, name:'Семья: папа, мама, два сына', price:80, ch:'👨‍👩‍👦‍👦', cat:'family'},
  {id:1894, name:'Семья: папа, мама, две дочери', price:80, ch:'👨‍👩‍👧‍👧', cat:'family'},
  {id:1895, name:'Семья: два папы, сын', price:80, ch:'👨‍👨‍👦', cat:'family'},
  {id:1896, name:'Семья: два папы, дочь', price:80, ch:'👨‍👨‍👧', cat:'family'},
  {id:1897, name:'Семья: два папы, дочь и сын', price:80, ch:'👨‍👨‍👧‍👦', cat:'family'},
  {id:1898, name:'Семья: два папы, два сына', price:80, ch:'👨‍👨‍👦‍👦', cat:'family'},
  {id:1899, name:'Семья: два папы, две дочери', price:80, ch:'👨‍👨‍👧‍👧', cat:'family'},
  {id:1900, name:'Семья: две мамы, сын', price:80, ch:'👩‍👩‍👦', cat:'family'},
  {id:1901, name:'Семья: две мамы, дочь', price:80, ch:'👩‍👩‍👧', cat:'family'},
  {id:1902, name:'Семья: две мамы, дочь и сын', price:80, ch:'👩‍👩‍👧‍👦', cat:'family'},
  {id:1903, name:'Семья: две мамы, два сына', price:80, ch:'👩‍👩‍👦‍👦', cat:'family'},
  {id:1904, name:'Семья: две мамы, две дочери', price:80, ch:'👩‍👩‍👧‍👧', cat:'family'},
  {id:1905, name:'Семья: папа и сын', price:80, ch:'👨‍👦', cat:'family'},
  {id:1906, name:'Семья: папа и два сына', price:80, ch:'👨‍👦‍👦', cat:'family'},
  {id:1907, name:'Семья: папа и дочь', price:80, ch:'👨‍👧', cat:'family'},
  {id:1908, name:'Семья: папа, дочь и сын', price:80, ch:'👨‍👧‍👦', cat:'family'},
  {id:1909, name:'Семья: папа и две дочери', price:80, ch:'👨‍👧‍👧', cat:'family'},
  {id:1910, name:'Семья: мама и сын', price:80, ch:'👩‍👦', cat:'family'},
  {id:1911, name:'Семья: мама и два сына', price:80, ch:'👩‍👦‍👦', cat:'family'},
  {id:1912, name:'Семья: мама и дочь', price:80, ch:'👩‍👧', cat:'family'},
  {id:1913, name:'Семья: мама, дочь и сын', price:80, ch:'👩‍👧‍👦', cat:'family'},
  {id:1914, name:'Семья: мама и две дочери', price:80, ch:'👩‍👧‍👧', cat:'family'},
  {id:1915, name:'Говорящая голова', price:80, ch:'🗣️', cat:'person'},
  {id:1916, name:'Силуэт человека', price:80, ch:'👤', cat:'person'},
  {id:1917, name:'Силуэты людей', price:80, ch:'👥', cat:'person'},
  {id:1918, name:'Объятия', price:80, ch:'🫂', cat:'person'},
  {id:1919, name:'Семья', price:80, ch:'👪', cat:'family'},
  {id:1920, name:'Семья: 2 взрослых, ребёнок', price:80, ch:'🧑‍🧑‍🧒', cat:'family'},
  {id:1921, name:'Семья: 2 взрослых, 2 ребёнка', price:80, ch:'🧑‍🧑‍🧒‍🧒', cat:'family'},
  {id:1922, name:'Семья: взрослый и ребёнок', price:80, ch:'🧑‍🧒', cat:'family'},
  {id:1923, name:'Семья: взрослый, 2 ребёнка', price:80, ch:'🧑‍🧒‍🧒', cat:'family'},
  {id:1924, name:'Следы', price:80, ch:'👣', cat:'person'},
  {id:1925, name:'Отпечаток пальца', price:80, ch:'🫆', cat:'person'},
  {id:1926, name:'Мешки под глазами', price:80, ch:'🫩', cat:'faces'},
];
