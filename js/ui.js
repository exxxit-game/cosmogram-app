  ...
  if(W && H){
    ...
    if(x){
      ...
      /* 11.09.2026 (владелец, живой скрин с кругом: «явление заходит за линию, где золотой
         ...
         границе холста) — резерв технически НУЖЕН, просто не выдуманного размера. Пробовал
         вырез по форме плашки (полный клип под её шириной, правее — до самого низа холста,
         раз там пусто) — владелец прямо отклонил, «лишнее», не просил. Итог — простой прямой
         вырез на всю ширину (как и был), но САМО число подобрано красный→зелёный на стражe
         316, не придумано: +4 красный (реальное наложение), +10 зелёный трижды подряд. */
