...
/* 01.09.2026 «Настроение неба» — гармония и случайное небо. Источник: обычный поворот круга
   ...
   было вообще ни одной. Пересобрано в 10 — владелец прямо попросил не держаться числа 18,
   «сколько реально можно, но пусть будут полностью разные»: жадный алгоритм по максимальному
   взаимному расстоянию + проверка глазами (macet_pt_pairs_cleanup / render_final_pairs,
   08.09.2026) — каждая пара действительно не похожа на соседние на реальных карточках, не
   только по числам. */
const PT_SAFE_PAIRS=[
  [220,260],[45,5],[90,180],[90,130],[355,265],[0,320],[45,315],[165,205],[200,340],[300,260],
];
