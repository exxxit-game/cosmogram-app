...
const I18N = {
  ru: {
    ...
    recordGyro:'Рекорд гироскопа', recordTouch:'Рекорд тача',
    dist:'Дистанция', recordDist:'Рекорд дистанции',
    bullet:'Замедление времени', recordBullet:'Рекорд замедления',
    modes:'Для Про', modesBack:'Назад',
    ...
    fpGarden:'Кометный сад', fpSlalom:'Коридор врат', fpHunt:'Сафари с искателями', fpPulse:'Пульсар',
    ...
    pillGyro:'Рекорд гироскопа', pillTouch:'Рекорд тача', pillDist:'Рекорд дистанции', pillBullet:'Рекорд замедления времени',
    ...
    aboutBtn:'Об игре',
    modeGyro:'Гироскоп', modeTouch:'Тач',
    ...
    home:'На экран «Домой»',
    shield:'Щит', magnet:'Магнит', slowmo:'Слоу-мо', life:'+Жизнь', dash:'Пуля', nova:'Сверхновая', shieldDown:'Щит снят', nearMiss:'Впритык', gate:'Ворота',
  ...
  en: {
    ...
    home:'Add to Home',
    shield:'Shield', magnet:'Magnet', slowmo:'Slow-mo', life:'+Life', dash:'Bullet', nova:'Supernova', shieldDown:'Shield down', nearMiss:'Close call', gate:'Gate',
...
const GAME_VERSION='1.105.0'; // «Об игре» в настройках — при репортах багов спрашивать её
